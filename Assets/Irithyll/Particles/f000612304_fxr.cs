...
namespace IrithyllParticles
{
    ...
    /// Source: f000612304.fxr
    /// Effect ID: 612304
    /// Generated emitters: 31
    /// </summary>
    public class f000612304_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 2.53f;
            main5.startLifetime = 2.53f;
            ...
            main10.duration = 2.53f;
            main10.startLifetime = 2.53f;
            ...
            main15.duration = 2.53f;
            main15.startLifetime = 2.53f;
            ...
            main16.duration = 10.00f;
            main16.startLifetime = 10.00f;
            ...
            main20.duration = 2.53f;
            main20.startLifetime = 2.53f;
            ...
            main25.duration = 2.53f;
            main25.startLifetime = 2.53f;
            ...
            main31.duration = 2.53f;
            main31.startLifetime = 2.53f;
