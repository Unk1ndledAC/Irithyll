...
namespace IrithyllParticles
{
    ...
    /// Source: f000612311.fxr
    /// Effect ID: 612311
    /// Generated emitters: 57
    /// </summary>
    public class f000612311_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 0.80f;
            main3.startLifetime = 0.80f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.80f;
            main4.startLifetime = 0.80f;
            ...
            var main5 = ps5.main;
            main5.duration = 0.50f;
            main5.startLifetime = 0.50f;
            ...
            var main9 = ps9.main;
            main9.duration = 0.10f;
            main9.startLifetime = 0.10f;
            ...
            main13.duration = 0.80f;
            main13.startLifetime = 0.80f;
            ...
            main14.duration = 0.80f;
            main14.startLifetime = 0.80f;
            ...
            main15.duration = 0.50f;
            main15.startLifetime = 0.50f;
            ...
            main16.duration = 0.10f;
            main16.startLifetime = 0.10f;
            ...
            main17.duration = 0.10f;
            main17.startLifetime = 0.10f;
            ...
            main18.duration = 0.10f;
            main18.startLifetime = 0.10f;
            ...
            main21.duration = 2.00f;
            main21.startLifetime = 2.00f;
            ...
            main23.duration = 0.80f;
            main23.startLifetime = 0.80f;
            ...
            main24.duration = 0.50f;
            main24.startLifetime = 0.50f;
            ...
            main25.duration = 0.10f;
            main25.startLifetime = 0.10f;
            ...
            main26.duration = 0.10f;
            main26.startLifetime = 0.10f;
            ...
            main27.duration = 0.10f;
            main27.startLifetime = 0.10f;
            ...
            main31.duration = 2.00f;
            main31.startLifetime = 2.00f;
            ...
            main32.duration = 0.80f;
            main32.startLifetime = 0.80f;
            ...
            main35.duration = 0.10f;
            main35.startLifetime = 0.10f;
            ...
            main36.duration = 0.10f;
            main36.startLifetime = 0.10f;
            ...
            main37.duration = 0.10f;
            main37.startLifetime = 0.10f;
            ...
            main38.duration = 0.10f;
            main38.startLifetime = 0.10f;
            ...
            main42.duration = 0.80f;
            main42.startLifetime = 0.80f;
            ...
            main45.duration = 0.10f;
            main45.startLifetime = 0.10f;
            ...
            main46.duration = 0.10f;
            main46.startLifetime = 0.10f;
            ...
            main50.duration = 0.80f;
            main50.startLifetime = 0.80f;
            ...
            main51.duration = 0.80f;
            main51.startLifetime = 0.80f;
            ...
            main52.duration = 0.50f;
            main52.startLifetime = 0.50f;
            ...
            main53.duration = 0.10f;
            main53.startLifetime = 0.10f;
            ...
            // Color over lifetime
            var color53 = ps53.colorOverLifetime;
            color53.enabled = true;
            Gradient gradient53 = new Gradient();
            gradient53.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.71f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.71f, 0.50f), 1.00f)
            ...
            main56.duration = 0.10f;
            main56.startLifetime = 0.10f;
