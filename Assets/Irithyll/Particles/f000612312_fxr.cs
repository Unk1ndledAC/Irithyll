...
namespace IrithyllParticles
{
    ...
    /// Source: f000612312.fxr
    /// Effect ID: 612312
    /// Generated emitters: 15
    /// </summary>
    public class f000612312_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient2.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.87f, 0.75f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.87f, 0.75f), 1.00f)
                },
