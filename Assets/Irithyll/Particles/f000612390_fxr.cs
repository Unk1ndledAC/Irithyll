...
namespace IrithyllParticles
{
    ...
    /// Source: f000612390.fxr
    /// Effect ID: 612390
    /// Generated emitters: 27
    /// </summary>
    public class f000612390_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.80f;
            main2.startLifetime = 0.80f;
            ...
            main20.duration = 0.80f;
            main20.startLifetime = 0.80f;
