...
namespace IrithyllParticles
{
    ...
    /// Source: f000612391.fxr
    /// Effect ID: 612391
    /// Generated emitters: 24
    /// </summary>
    public class f000612391_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main6 = ps6.main;
            main6.duration = 6.00f;
            main6.startLifetime = 6.00f;
            ...
            main14.duration = 6.00f;
            main14.startLifetime = 6.00f;
            ...
            shape19.shapeType = ParticleSystemShapeType.Box;
            shape19.radius = 0.5f;
