...
namespace IrithyllParticles
{
    ...
    /// Source: f000613521.fxr
    /// Effect ID: 613521
    /// Generated emitters: 42
    /// </summary>
    public class f000613521_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main11.duration = 0.67f;
            main11.startLifetime = 0.67f;
            ...
            main37.duration = 0.67f;
            main37.startLifetime = 0.67f;
