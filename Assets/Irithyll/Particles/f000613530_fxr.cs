...
namespace IrithyllParticles
{
    ...
    /// Source: f000613530.fxr
    /// Effect ID: 613530
    /// Generated emitters: 120
    /// </summary>
    public class f000613530_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.60f;
            main2.startLifetime = 0.60f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.20f;
            main4.startLifetime = 0.20f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.30f;
            main6.startLifetime = 0.30f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.10f;
            main8.startLifetime = 0.10f;
            ...
            main10.duration = 0.40f;
            main10.startLifetime = 0.40f;
            ...
            main11.duration = 0.20f;
            main11.startLifetime = 0.20f;
            ...
            main12.duration = 0.20f;
            main12.startLifetime = 0.20f;
            ...
            main14.duration = 0.30f;
            main14.startLifetime = 0.30f;
            ...
            main15.duration = 0.30f;
            main15.startLifetime = 0.30f;
            ...
            main16.duration = 0.30f;
            main16.startLifetime = 0.30f;
            ...
            main17.duration = 0.30f;
            main17.startLifetime = 0.30f;
            ...
            main23.duration = 0.60f;
            main23.startLifetime = 0.60f;
            ...
            main25.duration = 0.20f;
            main25.startLifetime = 0.20f;
            ...
            main26.duration = 0.30f;
            main26.startLifetime = 0.30f;
            ...
            main27.duration = 0.30f;
            main27.startLifetime = 0.30f;
            ...
            main28.duration = 0.10f;
            main28.startLifetime = 0.10f;
            ...
            main29.duration = 0.10f;
            main29.startLifetime = 0.10f;
            ...
            main31.duration = 0.40f;
            main31.startLifetime = 0.40f;
            ...
            main32.duration = 0.20f;
            main32.startLifetime = 0.20f;
            ...
            main34.duration = 0.30f;
            main34.startLifetime = 0.30f;
            ...
            main36.duration = 0.30f;
            main36.startLifetime = 0.30f;
            ...
            main37.duration = 0.30f;
            main37.startLifetime = 0.30f;
            ...
            main38.duration = 0.30f;
            main38.startLifetime = 0.30f;
            ...
            main40.duration = 2.00f;
            main40.startLifetime = 2.00f;
            ...
            main41.duration = 2.00f;
            main41.startLifetime = 2.00f;
            ...
            main42.duration = 0.60f;
            main42.startLifetime = 0.60f;
            ...
            main43.duration = 2.00f;
            main43.startLifetime = 2.00f;
            ...
            main46.duration = 0.30f;
            main46.startLifetime = 0.30f;
            ...
            main47.duration = 0.10f;
            main47.startLifetime = 0.10f;
            ...
            main48.duration = 0.10f;
            main48.startLifetime = 0.10f;
            ...
            main50.duration = 0.40f;
            main50.startLifetime = 0.40f;
            ...
            main53.duration = 0.30f;
            main53.startLifetime = 0.30f;
            ...
            main54.duration = 0.30f;
            main54.startLifetime = 0.30f;
            ...
            main55.duration = 0.30f;
            main55.startLifetime = 0.30f;
            ...
            main57.duration = 0.30f;
            main57.startLifetime = 0.30f;
            ...
            main59.duration = 2.00f;
            main59.startLifetime = 2.00f;
            ...
            main60.duration = 2.00f;
            main60.startLifetime = 2.00f;
            ...
            main61.duration = 3.00f;
            main61.startLifetime = 3.00f;
            ...
            main62.duration = 2.00f;
            main62.startLifetime = 2.00f;
            ...
            main63.duration = 0.60f;
            main63.startLifetime = 0.60f;
            ...
            main65.duration = 0.20f;
            main65.startLifetime = 0.20f;
            ...
            main66.duration = 0.30f;
            main66.startLifetime = 0.30f;
            ...
            main67.duration = 0.30f;
            main67.startLifetime = 0.30f;
            ...
            main68.duration = 0.10f;
            main68.startLifetime = 0.10f;
            ...
            main71.duration = 0.40f;
            main71.startLifetime = 0.40f;
            ...
            main73.duration = 0.20f;
            main73.startLifetime = 0.20f;
            ...
            main74.duration = 0.30f;
            main74.startLifetime = 0.30f;
            ...
            main75.duration = 0.30f;
            main75.startLifetime = 0.30f;
            ...
            main76.duration = 0.30f;
            main76.startLifetime = 0.30f;
            ...
            main77.duration = 0.30f;
            main77.startLifetime = 0.30f;
            ...
            main78.duration = 0.30f;
            main78.startLifetime = 0.30f;
            ...
            main79.duration = 2.00f;
            main79.startLifetime = 2.00f;
            ...
            main80.duration = 2.00f;
            main80.startLifetime = 2.00f;
            ...
            main81.duration = 2.00f;
            main81.startLifetime = 2.00f;
            ...
            main82.duration = 0.60f;
            main82.startLifetime = 0.60f;
            ...
            main83.duration = 2.00f;
            main83.startLifetime = 2.00f;
            ...
            main84.duration = 0.20f;
            main84.startLifetime = 0.20f;
            ...
            main85.duration = 0.30f;
            main85.startLifetime = 0.30f;
            ...
            main86.duration = 0.30f;
            main86.startLifetime = 0.30f;
            ...
            main87.duration = 0.10f;
            main87.startLifetime = 0.10f;
            ...
            main88.duration = 0.10f;
            main88.startLifetime = 0.10f;
            ...
            main90.duration = 0.40f;
            main90.startLifetime = 0.40f;
            ...
            main91.duration = 0.20f;
            main91.startLifetime = 0.20f;
            ...
            main93.duration = 0.30f;
            main93.startLifetime = 0.30f;
            ...
            main95.duration = 0.30f;
            main95.startLifetime = 0.30f;
            ...
            main96.duration = 0.30f;
            main96.startLifetime = 0.30f;
            ...
            main97.duration = 0.30f;
            main97.startLifetime = 0.30f;
            ...
            main98.duration = 2.00f;
            main98.startLifetime = 2.00f;
            ...
            main101.duration = 0.60f;
            main101.startLifetime = 0.60f;
            ...
            main104.duration = 0.30f;
            main104.startLifetime = 0.30f;
            ...
            main105.duration = 0.30f;
            main105.startLifetime = 0.30f;
            ...
            main106.duration = 0.10f;
            main106.startLifetime = 0.10f;
            ...
            main107.duration = 0.10f;
            main107.startLifetime = 0.10f;
            ...
            main109.duration = 0.40f;
            main109.startLifetime = 0.40f;
            ...
            main110.duration = 0.20f;
            main110.startLifetime = 0.20f;
            ...
            main111.duration = 0.20f;
            main111.startLifetime = 0.20f;
            ...
            main112.duration = 0.30f;
            main112.startLifetime = 0.30f;
            ...
            main113.duration = 0.30f;
            main113.startLifetime = 0.30f;
            ...
            main114.duration = 0.30f;
            main114.startLifetime = 0.30f;
            ...
            main115.duration = 0.30f;
            main115.startLifetime = 0.30f;
            ...
            main118.duration = 2.00f;
            main118.startLifetime = 2.00f;
            ...
            main119.duration = 2.00f;
            main119.startLifetime = 2.00f;
            ...
            main120.duration = 3.00f;
            main120.startLifetime = 3.00f;
