...
namespace IrithyllParticles
{
    ...
    /// Source: f000614103.fxr
    /// Effect ID: 614103
    /// Generated emitters: 24
    /// </summary>
    public class f000614103_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
