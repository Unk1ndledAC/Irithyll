...
namespace IrithyllParticles
{
    ...
    /// Source: f000614110.fxr
    /// Effect ID: 614110
    /// Generated emitters: 48
    /// </summary>
    public class f000614110_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 1.20f;
            main2.startLifetime = 1.20f;
            ...
            shape7.shapeType = ParticleSystemShapeType.Box;
            shape7.radius = 0.5f;
            ...
            main11.duration = 1.20f;
            main11.startLifetime = 1.20f;
            ...
            main34.duration = 1.20f;
            main34.startLifetime = 1.20f;
            ...
            main41.duration = 1.20f;
            main41.startLifetime = 1.20f;
