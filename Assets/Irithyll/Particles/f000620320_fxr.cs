...
namespace IrithyllParticles
{
    ...
    /// Source: f000620320.fxr
    /// Effect ID: 620320
    /// Generated emitters: 21
    /// </summary>
    public class f000620320_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 10.00f;
            main5.startLifetime = 10.00f;
            ...
            main12.duration = 10.00f;
            main12.startLifetime = 10.00f;
