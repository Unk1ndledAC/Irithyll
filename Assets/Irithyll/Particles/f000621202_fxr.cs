...
namespace IrithyllParticles
{
    ...
    /// Source: f000621202.fxr
    /// Effect ID: 621202
    /// Generated emitters: 30
    /// </summary>
    public class f000621202_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 0.50f;
            main1.startLifetime = 0.50f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.50f;
            main7.startLifetime = 0.50f;
            ...
            var main9 = ps9.main;
            main9.duration = 0.67f;
            main9.startLifetime = 0.67f;
