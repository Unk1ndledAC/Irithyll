...
namespace IrithyllParticles
{
    ...
    /// Source: f000621330.fxr
    /// Effect ID: 621330
    /// Generated emitters: 9
    /// </summary>
    public class f000621330_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 3.35f;
            main2.startLifetime = 3.35f;
            ...
            var main4 = ps4.main;
            main4.duration = 3.35f;
            main4.startLifetime = 3.35f;
            ...
            var main5 = ps5.main;
            main5.duration = 3.35f;
            main5.startLifetime = 3.35f;
            ...
            var main7 = ps7.main;
            main7.duration = 3.35f;
            main7.startLifetime = 3.35f;
            ...
            var main8 = ps8.main;
            main8.duration = 3.35f;
            main8.startLifetime = 3.35f;
            ...
            var main9 = ps9.main;
            main9.duration = 3.35f;
            main9.startLifetime = 3.35f;
