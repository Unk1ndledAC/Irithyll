...
namespace IrithyllParticles
{
    ...
    /// Source: f000622108.fxr
    /// Effect ID: 622108
    /// Generated emitters: 30
    /// </summary>
    public class f000622108_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main22.duration = 0.50f;
            main22.startLifetime = 0.50f;
