...
namespace IrithyllParticles
{
    ...
    /// Source: f000622111.fxr
    /// Effect ID: 622111
    /// Generated emitters: 15
    /// </summary>
    public class f000622111_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
