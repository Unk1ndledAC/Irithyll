...
namespace IrithyllParticles
{
    ...
    /// Source: f000622120.fxr
    /// Effect ID: 622120
    /// Generated emitters: 9
    /// </summary>
    public class f000622120_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.17f;
            main2.startLifetime = 0.17f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.17f;
            main4.startLifetime = 0.17f;
            ...
            var main5 = ps5.main;
            main5.duration = 0.17f;
            main5.startLifetime = 0.17f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.17f;
            main7.startLifetime = 0.17f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.17f;
            main8.startLifetime = 0.17f;
            ...
            var main9 = ps9.main;
            main9.duration = 0.17f;
            main9.startLifetime = 0.17f;
