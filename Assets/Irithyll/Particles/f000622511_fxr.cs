...
namespace IrithyllParticles
{
    ...
    /// Source: f000622511.fxr
    /// Effect ID: 622511
    /// Generated emitters: 15
    /// </summary>
    public class f000622511_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
