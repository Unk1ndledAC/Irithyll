...
namespace IrithyllParticles
{
    ...
    /// Source: f000622512.fxr
    /// Effect ID: 622512
    /// Generated emitters: 30
    /// </summary>
    public class f000622512_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 0.67f;
            main5.startLifetime = 0.67f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.67f;
            main6.startLifetime = 0.67f;
            ...
            main15.duration = 0.67f;
            main15.startLifetime = 0.67f;
            ...
            main16.duration = 0.67f;
            main16.startLifetime = 0.67f;
            ...
            main24.duration = 3.33f;
            main24.startLifetime = 3.33f;
            ...
            main25.duration = 0.67f;
            main25.startLifetime = 0.67f;
            ...
            main26.duration = 0.67f;
            main26.startLifetime = 0.67f;
            ...
            main27.duration = 0.67f;
            main27.startLifetime = 0.67f;
            ...
            main28.duration = 0.67f;
            main28.startLifetime = 0.67f;
