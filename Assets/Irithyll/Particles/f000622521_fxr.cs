...
namespace IrithyllParticles
{
    ...
    /// Source: f000622521.fxr
    /// Effect ID: 622521
    /// Generated emitters: 168
    /// </summary>
    public class f000622521_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main6 = ps6.main;
            main6.duration = 3.00f;
            main6.startLifetime = 3.00f;
            ...
            var main7 = ps7.main;
            main7.duration = 3.00f;
            main7.startLifetime = 3.00f;
            ...
            var main8 = ps8.main;
            main8.duration = 3.00f;
            main8.startLifetime = 3.00f;
            ...
            main13.duration = 0.30f;
            main13.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color16 = ps16.colorOverLifetime;
            color16.enabled = true;
            Gradient gradient16 = new Gradient();
            gradient16.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 1.00f)
                },
            ...
            gradient19.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 1.00f)
                },
                new GradientAlphaKey[] {
                    new GradientAlphaKey(1.00f, 0f),
                    new GradientAlphaKey(1.00f, 1f)
            ...
            main29.duration = 3.00f;
            main29.startLifetime = 3.00f;
            ...
            main30.duration = 3.00f;
            main30.startLifetime = 3.00f;
            ...
            main45.duration = 0.30f;
            main45.startLifetime = 0.30f;
            ...
            main50.duration = 0.30f;
            main50.startLifetime = 0.30f;
            ...
            main55.duration = 0.10f;
            main55.startLifetime = 0.10f;
            ...
            main56.duration = 0.30f;
            main56.startLifetime = 0.30f;
            ...
            main59.duration = 0.10f;
            main59.startLifetime = 0.10f;
            ...
            main60.duration = 0.30f;
            main60.startLifetime = 0.30f;
            ...
            main65.duration = 0.30f;
            main65.startLifetime = 0.30f;
            ...
            main69.duration = 0.30f;
            main69.startLifetime = 0.30f;
            ...
            main72.duration = 3.00f;
            main72.startLifetime = 3.00f;
            ...
            main75.duration = 2.00f;
            main75.startLifetime = 2.00f;
            ...
            main81.duration = 3.00f;
            main81.startLifetime = 3.00f;
            ...
            main82.duration = 3.00f;
            main82.startLifetime = 3.00f;
            ...
            main91.duration = 3.00f;
            main91.startLifetime = 3.00f;
            ...
            main92.duration = 3.00f;
            main92.startLifetime = 3.00f;
            ...
            main104.duration = 3.00f;
            main104.startLifetime = 3.00f;
            ...
            main105.duration = 3.00f;
            main105.startLifetime = 3.00f;
            ...
            main106.duration = 3.00f;
            main106.startLifetime = 3.00f;
            ...
            main111.duration = 0.30f;
            main111.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color114 = ps114.colorOverLifetime;
            color114.enabled = true;
            Gradient gradient114 = new Gradient();
            gradient114.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 1.00f)
            ...
            main116.duration = 0.30f;
            main116.startLifetime = 0.30f;
            ...
            main121.duration = 0.10f;
            main121.startLifetime = 0.10f;
            ...
            main122.duration = 0.30f;
            main122.startLifetime = 0.30f;
            ...
            main125.duration = 0.10f;
            main125.startLifetime = 0.10f;
            ...
            main126.duration = 0.30f;
            main126.startLifetime = 0.30f;
            ...
            main131.duration = 0.30f;
            main131.startLifetime = 0.30f;
            ...
            main135.duration = 0.30f;
            main135.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color136 = ps136.colorOverLifetime;
            color136.enabled = true;
            Gradient gradient136 = new Gradient();
            gradient136.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 1.00f)
            ...
            main141.duration = 0.30f;
            main141.startLifetime = 0.30f;
            ...
            main144.duration = 0.10f;
            main144.startLifetime = 0.10f;
            ...
            main145.duration = 0.30f;
            main145.startLifetime = 0.30f;
            ...
            main148.duration = 0.10f;
            main148.startLifetime = 0.10f;
            ...
            main149.duration = 0.30f;
            main149.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color152 = ps152.colorOverLifetime;
            color152.enabled = true;
            Gradient gradient152 = new Gradient();
            gradient152.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 1.00f)
            ...
            main154.duration = 0.30f;
            main154.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color155 = ps155.colorOverLifetime;
            color155.enabled = true;
            Gradient gradient155 = new Gradient();
            gradient155.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 1.00f)
            ...
            // Color over lifetime
            var color156 = ps156.colorOverLifetime;
            color156.enabled = true;
            Gradient gradient156 = new Gradient();
            gradient156.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 1.00f)
            ...
            main158.duration = 0.30f;
            main158.startLifetime = 0.30f;
            ...
            // Color over lifetime
            var color159 = ps159.colorOverLifetime;
            color159.enabled = true;
            Gradient gradient159 = new Gradient();
            gradient159.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.62f, 0.25f), 1.00f)
            ...
            // Color over lifetime
            var color160 = ps160.colorOverLifetime;
            color160.enabled = true;
            Gradient gradient160 = new Gradient();
            gradient160.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.84f, 0.50f), 1.00f)
            ...
            main162.duration = 0.30f;
            main162.startLifetime = 0.30f;
            ...
            main165.duration = 3.00f;
            main165.startLifetime = 3.00f;
