...
namespace IrithyllParticles
{
    ...
    /// Source: f000622523.fxr
    /// Effect ID: 622523
    /// Generated emitters: 18
    /// </summary>
    public class f000622523_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main4 = ps4.main;
            main4.duration = 4.00f;
            main4.startLifetime = 4.00f;
            ...
            main10.duration = 4.00f;
            main10.startLifetime = 4.00f;
            ...
            main18.duration = 4.00f;
            main18.startLifetime = 4.00f;
