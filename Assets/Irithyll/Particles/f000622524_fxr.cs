...
namespace IrithyllParticles
{
    ...
    /// Source: f000622524.fxr
    /// Effect ID: 622524
    /// Generated emitters: 63
    /// </summary>
    public class f000622524_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 0.67f;
            main1.startLifetime = 0.67f;
            ...
            var main3 = ps3.main;
            main3.duration = 0.30f;
            main3.startLifetime = 0.30f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.30f;
            main7.startLifetime = 0.30f;
            ...
            main12.duration = 0.67f;
            main12.startLifetime = 0.67f;
            ...
            main17.duration = 0.40f;
            main17.startLifetime = 0.40f;
            ...
            main27.duration = 0.40f;
            main27.startLifetime = 0.40f;
            ...
            main33.duration = 0.67f;
            main33.startLifetime = 0.67f;
            ...
            main38.duration = 0.40f;
            main38.startLifetime = 0.40f;
            ...
            main58.duration = 0.40f;
            main58.startLifetime = 0.40f;
            ...
            main62.duration = 0.50f;
            main62.startLifetime = 0.50f;
