...
namespace IrithyllParticles
{
    ...
    /// Source: f000622525.fxr
    /// Effect ID: 622525
    /// Generated emitters: 82
    /// </summary>
    public class f000622525_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main79.duration = 3.00f;
            main79.startLifetime = 3.00f;
