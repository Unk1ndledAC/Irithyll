...
namespace IrithyllParticles
{
    ...
    /// Source: f000622900.fxr
    /// Effect ID: 622900
    /// Generated emitters: 21
    /// </summary>
    public class f000622900_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
