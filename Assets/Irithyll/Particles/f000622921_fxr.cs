...
namespace IrithyllParticles
{
    ...
    /// Source: f000622921.fxr
    /// Effect ID: 622921
    /// Generated emitters: 39
    /// </summary>
    public class f000622921_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 0.33f;
            main1.startLifetime = 0.33f;
            ...
            var main3 = ps3.main;
            main3.duration = 0.33f;
            main3.startLifetime = 0.33f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.33f;
            main4.startLifetime = 0.33f;
            ...
            main10.duration = 0.33f;
            main10.startLifetime = 0.33f;
            ...
            main11.duration = 0.33f;
            main11.startLifetime = 0.33f;
            ...
            main16.duration = 0.33f;
            main16.startLifetime = 0.33f;
            ...
            main21.duration = 0.33f;
            main21.startLifetime = 0.33f;
            ...
            main23.duration = 0.33f;
            main23.startLifetime = 0.33f;
            ...
            main35.duration = 0.33f;
            main35.startLifetime = 0.33f;
            ...
            main36.duration = 0.33f;
            main36.startLifetime = 0.33f;
