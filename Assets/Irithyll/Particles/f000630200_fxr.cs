...
namespace IrithyllParticles
{
    ...
    /// Source: f000630200.fxr
    /// Effect ID: 630200
    /// Generated emitters: 54
    /// </summary>
    public class f000630200_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main4 = ps4.main;
            main4.duration = 0.67f;
            main4.startLifetime = 0.67f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.23f;
            main7.startLifetime = 0.23f;
            ...
            main10.duration = 1.17f;
            main10.startLifetime = 1.17f;
            ...
            main13.duration = 0.67f;
            main13.startLifetime = 0.67f;
            ...
            main14.duration = 0.67f;
            main14.startLifetime = 0.67f;
            ...
            main17.duration = 0.23f;
            main17.startLifetime = 0.23f;
            ...
            main20.duration = 1.17f;
            main20.startLifetime = 1.17f;
            ...
            main22.duration = 0.67f;
            main22.startLifetime = 0.67f;
            ...
            main25.duration = 0.23f;
            main25.startLifetime = 0.23f;
            ...
            main28.duration = 1.17f;
            main28.startLifetime = 1.17f;
            ...
            main29.duration = 4.00f;
            main29.startLifetime = 4.00f;
            ...
            main31.duration = 0.67f;
            main31.startLifetime = 0.67f;
            ...
            main32.duration = 0.67f;
            main32.startLifetime = 0.67f;
            ...
            main35.duration = 0.23f;
            main35.startLifetime = 0.23f;
            ...
            main38.duration = 1.17f;
            main38.startLifetime = 1.17f;
            ...
            main39.duration = 0.67f;
            main39.startLifetime = 0.67f;
            ...
            main40.duration = 0.67f;
            main40.startLifetime = 0.67f;
            ...
            emission42.rateOverTime = 300;

            // Shape
            var shape42 = ps42.shape;
            shape42.shapeType = ParticleSystemShapeType.Box;
            shape42.radius = 0.5f;
            ...
            main43.duration = 0.23f;
            main43.startLifetime = 0.23f;
            ...
            main46.duration = 1.17f;
            main46.startLifetime = 1.17f;
            ...
            main47.duration = 0.67f;
            main47.startLifetime = 0.67f;
            ...
            main48.duration = 0.67f;
            main48.startLifetime = 0.67f;
            ...
            emission50.rateOverTime = 300;

            // Shape
            var shape50 = ps50.shape;
            shape50.shapeType = ParticleSystemShapeType.Box;
            shape50.radius = 0.5f;
            ...
            main51.duration = 0.23f;
            main51.startLifetime = 0.23f;
            ...
            main54.duration = 1.17f;
            main54.startLifetime = 1.17f;
