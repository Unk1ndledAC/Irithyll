...
namespace IrithyllParticles
{
    ...
    /// Source: f000630210.fxr
    /// Effect ID: 630210
    /// Generated emitters: 36
    /// </summary>
    public class f000630210_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main8 = ps8.main;
            main8.duration = 4.00f;
            main8.startLifetime = 4.00f;
            ...
            main11.duration = 3.33f;
            main11.startLifetime = 3.33f;
            ...
            main14.duration = 0.83f;
            main14.startLifetime = 0.83f;
            ...
            main15.duration = 0.20f;
            main15.startLifetime = 0.20f;
            ...
            main16.duration = 3.33f;
            main16.startLifetime = 3.33f;
            ...
            main19.duration = 0.83f;
            main19.startLifetime = 0.83f;
            ...
            main20.duration = 4.00f;
            main20.startLifetime = 4.00f;
            ...
            main23.duration = 3.33f;
            main23.startLifetime = 3.33f;
            ...
            main26.duration = 0.83f;
            main26.startLifetime = 0.83f;
            ...
            main28.duration = 3.33f;
            main28.startLifetime = 3.33f;
            ...
            main31.duration = 0.83f;
            main31.startLifetime = 0.83f;
            ...
            main33.duration = 3.33f;
            main33.startLifetime = 3.33f;
            ...
            main36.duration = 0.83f;
            main36.startLifetime = 0.83f;
