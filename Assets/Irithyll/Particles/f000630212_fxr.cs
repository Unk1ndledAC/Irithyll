...
namespace IrithyllParticles
{
    ...
    /// Source: f000630212.fxr
    /// Effect ID: 630212
    /// Generated emitters: 42
    /// </summary>
    public class f000630212_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main4 = ps4.main;
            main4.duration = 3.33f;
            main4.startLifetime = 3.33f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.83f;
            main7.startLifetime = 0.83f;
            ...
            var main9 = ps9.main;
            main9.duration = 4.00f;
            main9.startLifetime = 4.00f;
            ...
            main15.duration = 0.83f;
            main15.startLifetime = 0.83f;
            ...
            main18.duration = 3.33f;
            main18.startLifetime = 3.33f;
            ...
            main21.duration = 0.83f;
            main21.startLifetime = 0.83f;
            ...
            main23.duration = 4.00f;
            main23.startLifetime = 4.00f;
            ...
            main26.duration = 3.33f;
            main26.startLifetime = 3.33f;
            ...
            main29.duration = 0.83f;
            main29.startLifetime = 0.83f;
            ...
            main32.duration = 3.33f;
            main32.startLifetime = 3.33f;
            ...
            main35.duration = 0.83f;
            main35.startLifetime = 0.83f;
            ...
            main38.duration = 3.33f;
            main38.startLifetime = 3.33f;
            ...
            main41.duration = 0.83f;
            main41.startLifetime = 0.83f;
