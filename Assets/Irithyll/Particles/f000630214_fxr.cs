...
namespace IrithyllParticles
{
    ...
    /// Source: f000630214.fxr
    /// Effect ID: 630214
    /// Generated emitters: 72
    /// </summary>
    public class f000630214_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main9 = ps9.main;
            main9.duration = 0.60f;
            main9.startLifetime = 0.60f;
            ...
            main12.duration = 3.33f;
            main12.startLifetime = 3.33f;
            ...
            main17.duration = 0.20f;
            main17.startLifetime = 0.20f;
            ...
            main22.duration = 0.60f;
            main22.startLifetime = 0.60f;
            ...
            shape24.shapeType = ParticleSystemShapeType.Box;
            shape24.radius = 0.5f;
            ...
            main25.duration = 3.33f;
            main25.startLifetime = 3.33f;
            ...
            main33.duration = 0.60f;
            main33.startLifetime = 0.60f;
            ...
            main36.duration = 3.33f;
            main36.startLifetime = 3.33f;
            ...
            main38.duration = 4.00f;
            main38.startLifetime = 4.00f;
            ...
            main46.duration = 0.60f;
            main46.startLifetime = 0.60f;
            ...
            main49.duration = 3.33f;
            main49.startLifetime = 3.33f;
            ...
            main54.duration = 0.20f;
            main54.startLifetime = 0.20f;
            ...
            main57.duration = 0.60f;
            main57.startLifetime = 0.60f;
            ...
            main60.duration = 3.33f;
            main60.startLifetime = 3.33f;
            ...
            main68.duration = 0.60f;
            main68.startLifetime = 0.60f;
            ...
            main71.duration = 3.33f;
            main71.startLifetime = 3.33f;
