...
namespace IrithyllParticles
{
    ...
    /// Source: f000630216.fxr
    /// Effect ID: 630216
    /// Generated emitters: 71
    /// </summary>
    public class f000630216_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main4 = ps4.main;
            main4.duration = 0.40f;
            main4.startLifetime = 0.40f;
            ...
            main15.duration = 0.40f;
            main15.startLifetime = 0.40f;
            ...
            main16.duration = 0.40f;
            main16.startLifetime = 0.40f;
            ...
            main25.duration = 0.40f;
            main25.startLifetime = 0.40f;
            ...
            main26.duration = 0.40f;
            main26.startLifetime = 0.40f;
            ...
            emission44.rateOverTime = 166;

            // Shape
            var shape44 = ps44.shape;
            shape44.shapeType = ParticleSystemShapeType.Box;
            shape44.radius = 0.5f;
            ...
            main51.duration = 0.40f;
            main51.startLifetime = 0.40f;
            ...
            main60.duration = 0.40f;
            main60.startLifetime = 0.40f;
            ...
            main64.duration = 0.40f;
            main64.startLifetime = 0.40f;
            ...
            main65.duration = 0.40f;
            main65.startLifetime = 0.40f;
