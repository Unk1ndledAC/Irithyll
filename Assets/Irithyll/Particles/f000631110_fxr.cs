...
namespace IrithyllParticles
{
    ...
    /// Source: f000631110.fxr
    /// Effect ID: 631110
    /// Generated emitters: 15
    /// </summary>
    public class f000631110_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
