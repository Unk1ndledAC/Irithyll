...
namespace IrithyllParticles
{
    ...
    /// Source: f000631120.fxr
    /// Effect ID: 631120
    /// Generated emitters: 21
    /// </summary>
    public class f000631120_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 1.33f;
            main5.startLifetime = 1.33f;
            ...
            main12.duration = 1.33f;
            main12.startLifetime = 1.33f;
