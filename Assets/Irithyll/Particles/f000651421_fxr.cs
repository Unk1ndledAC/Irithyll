...
namespace IrithyllParticles
{
    ...
    /// Source: f000651421.fxr
    /// Effect ID: 651421
    /// Generated emitters: 72
    /// </summary>
    public class f000651421_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 1.20f;
            main3.startLifetime = 1.20f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.10f;
            main6.startLifetime = 0.10f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.20f;
            main8.startLifetime = 0.20f;
            ...
            main10.duration = 0.20f;
            main10.startLifetime = 0.20f;
            ...
            main15.duration = 2.00f;
            main15.startLifetime = 2.00f;
            ...
            main16.duration = 1.20f;
            main16.startLifetime = 1.20f;
            ...
            main17.duration = 2.00f;
            main17.startLifetime = 2.00f;
            ...
            main20.duration = 0.20f;
            main20.startLifetime = 0.20f;
            ...
            main21.duration = 0.20f;
            main21.startLifetime = 0.20f;
            ...
            main26.duration = 2.00f;
            main26.startLifetime = 2.00f;
            ...
            main27.duration = 1.20f;
            main27.startLifetime = 1.20f;
            ...
            main29.duration = 0.20f;
            main29.startLifetime = 0.20f;
            ...
            main30.duration = 0.10f;
            main30.startLifetime = 0.10f;
            ...
            main31.duration = 0.20f;
            main31.startLifetime = 0.20f;
            ...
            main37.duration = 4.00f;
            main37.startLifetime = 4.00f;
            ...
            main40.duration = 1.20f;
            main40.startLifetime = 1.20f;
            ...
            main42.duration = 0.20f;
            main42.startLifetime = 0.20f;
            ...
            main45.duration = 0.20f;
            main45.startLifetime = 0.20f;
            ...
            main46.duration = 0.20f;
            main46.startLifetime = 0.20f;
            ...
            main47.duration = 0.20f;
            main47.startLifetime = 0.20f;
            ...
            main48.duration = 2.00f;
            main48.startLifetime = 2.00f;
            ...
            main50.duration = 2.00f;
            main50.startLifetime = 2.00f;
            ...
            main51.duration = 1.20f;
            main51.startLifetime = 1.20f;
            ...
            main53.duration = 0.20f;
            main53.startLifetime = 0.20f;
            ...
            main54.duration = 0.10f;
            main54.startLifetime = 0.10f;
            ...
            main57.duration = 0.20f;
            main57.startLifetime = 0.20f;
            ...
            main58.duration = 0.20f;
            main58.startLifetime = 0.20f;
            ...
            main61.duration = 2.00f;
            main61.startLifetime = 2.00f;
            ...
            main62.duration = 1.20f;
            main62.startLifetime = 1.20f;
            ...
            main64.duration = 0.20f;
            main64.startLifetime = 0.20f;
            ...
            main65.duration = 0.10f;
            main65.startLifetime = 0.10f;
            ...
            main69.duration = 0.20f;
            main69.startLifetime = 0.20f;
            ...
            // Color over lifetime
            var color69 = ps69.colorOverLifetime;
            color69.enabled = true;
            Gradient gradient69 = new Gradient();
            gradient69.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.71f, 0.50f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.71f, 0.50f), 1.00f)
            ...
            main70.duration = 2.00f;
            main70.startLifetime = 2.00f;
            ...
            main72.duration = 4.00f;
            main72.startLifetime = 4.00f;
