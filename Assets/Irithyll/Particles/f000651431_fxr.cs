...
namespace IrithyllParticles
{
    ...
    /// Source: f000651431.fxr
    /// Effect ID: 651431
    /// Generated emitters: 104
    /// </summary>
    public class f000651431_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main93.duration = 2.00f;
            main93.startLifetime = 2.00f;
            ...
            main97.duration = 2.00f;
            main97.startLifetime = 2.00f;
