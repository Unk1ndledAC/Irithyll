...
namespace IrithyllParticles
{
    ...
    /// Source: f000651435.fxr
    /// Effect ID: 651435
    /// Generated emitters: 84
    /// </summary>
    public class f000651435_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.10f;
            main2.startLifetime = 0.10f;
            ...
            var main3 = ps3.main;
            main3.duration = 0.10f;
            main3.startLifetime = 0.10f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.50f;
            main4.startLifetime = 0.50f;
            ...
            var main5 = ps5.main;
            main5.duration = 0.40f;
            main5.startLifetime = 0.40f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.40f;
            main6.startLifetime = 0.40f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.40f;
            main7.startLifetime = 0.40f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.80f;
            main8.startLifetime = 0.80f;
            ...
            main16.duration = 2.00f;
            main16.startLifetime = 2.00f;
            ...
            main19.duration = 0.50f;
            main19.startLifetime = 0.50f;
            ...
            main20.duration = 0.40f;
            main20.startLifetime = 0.40f;
            ...
            main21.duration = 0.40f;
            main21.startLifetime = 0.40f;
            ...
            main22.duration = 0.40f;
            main22.startLifetime = 0.40f;
            ...
            main32.duration = 0.50f;
            main32.startLifetime = 0.50f;
            ...
            main33.duration = 0.40f;
            main33.startLifetime = 0.40f;
            ...
            main34.duration = 0.40f;
            main34.startLifetime = 0.40f;
            ...
            main35.duration = 0.40f;
            main35.startLifetime = 0.40f;
            ...
            main42.duration = 2.00f;
            main42.startLifetime = 2.00f;
            ...
            main44.duration = 2.00f;
            main44.startLifetime = 2.00f;
            ...
            main48.duration = 0.40f;
            main48.startLifetime = 0.40f;
            ...
            main49.duration = 0.40f;
            main49.startLifetime = 0.40f;
            ...
            main54.duration = 2.00f;
            main54.startLifetime = 2.00f;
            ...
            main56.duration = 2.00f;
            main56.startLifetime = 2.00f;
            ...
            main57.duration = 2.00f;
            main57.startLifetime = 2.00f;
            ...
            emission58.rateOverTime = 30;

            // Shape
            var shape58 = ps58.shape;
            shape58.shapeType = ParticleSystemShapeType.Box;
            shape58.radius = 0.5f;
            ...
            main60.duration = 0.50f;
            main60.startLifetime = 0.50f;
            ...
            main61.duration = 0.40f;
            main61.startLifetime = 0.40f;
            ...
            main62.duration = 0.40f;
            main62.startLifetime = 0.40f;
            ...
            main63.duration = 0.40f;
            main63.startLifetime = 0.40f;
            ...
            main68.duration = 2.00f;
            main68.startLifetime = 2.00f;
            ...
            main71.duration = 0.10f;
            main71.startLifetime = 0.10f;
            ...
            main73.duration = 0.50f;
            main73.startLifetime = 0.50f;
            ...
            main74.duration = 0.40f;
            main74.startLifetime = 0.40f;
            ...
            main75.duration = 0.40f;
            main75.startLifetime = 0.40f;
            ...
            main76.duration = 0.40f;
            main76.startLifetime = 0.40f;
            ...
            main82.duration = 2.00f;
            main82.startLifetime = 2.00f;
