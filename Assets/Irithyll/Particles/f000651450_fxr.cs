...
namespace IrithyllParticles
{
    ...
    /// Source: f000651450.fxr
    /// Effect ID: 651450
    /// Generated emitters: 32
    /// </summary>
    public class f000651450_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 5.00f;
            main5.startLifetime = 5.00f;
            ...
            main15.duration = 5.00f;
            main15.startLifetime = 5.00f;
            ...
            main32.duration = 5.00f;
            main32.startLifetime = 5.00f;
