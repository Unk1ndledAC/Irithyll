...
namespace IrithyllParticles
{
    ...
    /// Source: f000651452.fxr
    /// Effect ID: 651452
    /// Generated emitters: 39
    /// </summary>
    public class f000651452_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main8 = ps8.main;
            main8.duration = 1.33f;
            main8.startLifetime = 1.33f;
            ...
            main21.duration = 1.33f;
            main21.startLifetime = 1.33f;
