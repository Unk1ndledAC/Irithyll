...
namespace IrithyllParticles
{
    ...
    /// Source: f000651471.fxr
    /// Effect ID: 651471
    /// Generated emitters: 42
    /// </summary>
    public class f000651471_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main9 = ps9.main;
            main9.duration = 5.00f;
            main9.startLifetime = 5.00f;
            ...
            main10.duration = 0.10f;
            main10.startLifetime = 0.10f;
            ...
            main23.duration = 5.00f;
            main23.startLifetime = 5.00f;
