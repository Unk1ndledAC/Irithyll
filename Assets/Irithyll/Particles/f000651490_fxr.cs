...
namespace IrithyllParticles
{
    ...
    /// Source: f000651490.fxr
    /// Effect ID: 651490
    /// Generated emitters: 21
    /// </summary>
    public class f000651490_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
