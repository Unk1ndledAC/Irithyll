...
namespace IrithyllParticles
{
    ...
    /// Source: f000651500.fxr
    /// Effect ID: 651500
    /// Generated emitters: 33
    /// </summary>
    public class f000651500_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main7 = ps7.main;
            main7.duration = 10.00f;
            main7.startLifetime = 10.00f;
            ...
            main33.duration = 10.00f;
            main33.startLifetime = 10.00f;
