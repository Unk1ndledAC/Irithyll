...
namespace IrithyllParticles
{
    ...
    /// Source: f000651501.fxr
    /// Effect ID: 651501
    /// Generated emitters: 27
    /// </summary>
    public class f000651501_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.40f;
            main2.startLifetime = 0.40f;
            ...
            main11.duration = 0.40f;
            main11.startLifetime = 0.40f;
            ...
            main25.duration = 0.50f;
            main25.startLifetime = 0.50f;
