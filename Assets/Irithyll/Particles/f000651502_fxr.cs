...
namespace IrithyllParticles
{
    ...
    /// Source: f000651502.fxr
    /// Effect ID: 651502
    /// Generated emitters: 66
    /// </summary>
    public class f000651502_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main6 = ps6.main;
            main6.duration = 10.00f;
            main6.startLifetime = 10.00f;
            ...
            main18.duration = 10.00f;
            main18.startLifetime = 10.00f;
            ...
            main24.duration = 10.00f;
            main24.startLifetime = 10.00f;
            ...
            main52.duration = 10.00f;
            main52.startLifetime = 10.00f;
