...
namespace IrithyllParticles
{
    ...
    /// Source: f000651504.fxr
    /// Effect ID: 651504
    /// Generated emitters: 54
    /// </summary>
    public class f000651504_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 0.40f;
            main3.startLifetime = 0.40f;
            ...
            main11.duration = 5.00f;
            main11.startLifetime = 5.00f;
            ...
            main13.duration = 0.40f;
            main13.startLifetime = 0.40f;
            ...
            main24.duration = 0.30f;
            main24.startLifetime = 0.30f;
            ...
            main29.duration = 5.00f;
            main29.startLifetime = 5.00f;
            ...
            main47.duration = 0.40f;
            main47.startLifetime = 0.40f;
            ...
            main49.duration = 0.30f;
            main49.startLifetime = 0.30f;
