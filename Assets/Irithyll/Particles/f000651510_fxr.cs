...
namespace IrithyllParticles
{
    ...
    /// Source: f000651510.fxr
    /// Effect ID: 651510
    /// Generated emitters: 64
    /// </summary>
    public class f000651510_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 10.00f;
            main2.startLifetime = 10.00f;
            ...
            main14.duration = 10.00f;
            main14.startLifetime = 10.00f;
            ...
            main27.duration = 10.00f;
            main27.startLifetime = 10.00f;
            ...
            main35.duration = 10.00f;
            main35.startLifetime = 10.00f;
            ...
            main54.duration = 10.00f;
            main54.startLifetime = 10.00f;
            ...
            main56.duration = 0.60f;
            main56.startLifetime = 0.60f;
            ...
            main58.duration = 0.60f;
            main58.startLifetime = 0.60f;
            ...
            main59.duration = 0.60f;
            main59.startLifetime = 0.60f;
            ...
            main61.duration = 0.60f;
            main61.startLifetime = 0.60f;
