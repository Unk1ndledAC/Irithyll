...
namespace IrithyllParticles
{
    ...
    /// Source: f000651512.fxr
    /// Effect ID: 651512
    /// Generated emitters: 60
    /// </summary>
    public class f000651512_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main4 = ps4.main;
            main4.duration = 3.00f;
            main4.startLifetime = 3.00f;
            ...
            main29.duration = 0.50f;
            main29.startLifetime = 0.50f;
            ...
            main49.duration = 0.50f;
            main49.startLifetime = 0.50f;
            ...
            main50.duration = 0.50f;
            main50.startLifetime = 0.50f;
            ...
            main56.duration = 3.00f;
            main56.startLifetime = 3.00f;
            ...
            main58.duration = 0.50f;
            main58.startLifetime = 0.50f;
