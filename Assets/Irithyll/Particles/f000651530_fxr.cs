...
namespace IrithyllParticles
{
    ...
    /// Source: f000651530.fxr
    /// Effect ID: 651530
    /// Generated emitters: 42
    /// </summary>
    public class f000651530_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient2.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(0.79f, 0.75f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(0.79f, 0.75f, 1.00f), 1.00f)
                },
            ...
            var main9 = ps9.main;
            main9.duration = 10.00f;
            main9.startLifetime = 10.00f;
