...
namespace IrithyllParticles
{
    ...
    /// Source: f000651532.fxr
    /// Effect ID: 651532
    /// Generated emitters: 70
    /// </summary>
    public class f000651532_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 1.33f;
            main1.startLifetime = 1.33f;
            ...
            var main5 = ps5.main;
            main5.duration = 2.00f;
            main5.startLifetime = 2.00f;
            ...
            gradient11.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.00f, 0.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.00f, 0.00f), 1.00f)
                },
            ...
            main13.duration = 1.33f;
            main13.startLifetime = 1.33f;
            ...
            shape28.shapeType = ParticleSystemShapeType.Box;
            shape28.radius = 0.5f;
            ...
            main36.duration = 1.33f;
            main36.startLifetime = 1.33f;
            ...
            shape51.shapeType = ParticleSystemShapeType.Box;
            shape51.radius = 0.5f;
            ...
            shape62.shapeType = ParticleSystemShapeType.Box;
            shape62.radius = 0.5f;
