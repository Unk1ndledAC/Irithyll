...
namespace IrithyllParticles
{
    ...
    /// Source: f000651546.fxr
    /// Effect ID: 651546
    /// Generated emitters: 36
    /// </summary>
    public class f000651546_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient2.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.75f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.75f), 1.00f)
                },
            ...
            var main8 = ps8.main;
            main8.duration = 10.00f;
            main8.startLifetime = 10.00f;
            ...
            main20.duration = 10.00f;
            main20.startLifetime = 10.00f;
