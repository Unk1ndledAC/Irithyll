...
namespace IrithyllParticles
{
    ...
    /// Source: f000651551.fxr
    /// Effect ID: 651551
    /// Generated emitters: 66
    /// </summary>
    public class f000651551_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            shape36.shapeType = ParticleSystemShapeType.Box;
            shape36.radius = 0.5f;
