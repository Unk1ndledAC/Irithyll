...
namespace IrithyllParticles
{
    ...
    /// Source: f000651553.fxr
    /// Effect ID: 651553
    /// Generated emitters: 72
    /// </summary>
    public class f000651553_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient4.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.63f, 0.37f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.63f, 0.37f), 1.00f)
                },
            ...
            shape26.shapeType = ParticleSystemShapeType.Box;
            shape26.radius = 0.5f;
            ...
            shape61.shapeType = ParticleSystemShapeType.Box;
            shape61.radius = 0.5f;
