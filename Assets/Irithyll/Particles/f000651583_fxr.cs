...
namespace IrithyllParticles
{
    ...
    /// Source: f000651583.fxr
    /// Effect ID: 651583
    /// Generated emitters: 57
    /// </summary>
    public class f000651583_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 0.10f;
            main1.startLifetime = 0.10f;
            ...
            // Color over lifetime
            var color1 = ps1.colorOverLifetime;
            color1.enabled = true;
            Gradient gradient1 = new Gradient();
            gradient1.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.91f, 0.75f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.91f, 0.75f), 1.00f)
                },
            ...
            var main2 = ps2.main;
            main2.duration = 1.50f;
            main2.startLifetime = 1.50f;
            ...
            var main3 = ps3.main;
            main3.duration = 0.05f;
            main3.startLifetime = 0.05f;
            ...
            var main4 = ps4.main;
            main4.duration = 0.05f;
            main4.startLifetime = 0.05f;
            ...
            var main5 = ps5.main;
            main5.duration = 1.50f;
            main5.startLifetime = 1.50f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.05f;
            main6.startLifetime = 0.05f;
            ...
            var main8 = ps8.main;
            main8.duration = 1.50f;
            main8.startLifetime = 1.50f;
            ...
            var main9 = ps9.main;
            main9.duration = 1.50f;
            main9.startLifetime = 1.50f;
            ...
            main13.duration = 1.50f;
            main13.startLifetime = 1.50f;
            ...
            main14.duration = 0.05f;
            main14.startLifetime = 0.05f;
            ...
            main15.duration = 0.05f;
            main15.startLifetime = 0.05f;
            ...
            main16.duration = 1.50f;
            main16.startLifetime = 1.50f;
            ...
            main17.duration = 0.05f;
            main17.startLifetime = 0.05f;
            ...
            main22.duration = 0.05f;
            main22.startLifetime = 0.05f;
            ...
            main23.duration = 0.05f;
            main23.startLifetime = 0.05f;
            ...
            main25.duration = 0.05f;
            main25.startLifetime = 0.05f;
            ...
            main27.duration = 1.50f;
            main27.startLifetime = 1.50f;
            ...
            main28.duration = 1.50f;
            main28.startLifetime = 1.50f;
            ...
            main29.duration = 1.50f;
            main29.startLifetime = 1.50f;
            ...
            main30.duration = 4.00f;
            main30.startLifetime = 4.00f;
            ...
            main32.duration = 1.50f;
            main32.startLifetime = 1.50f;
            ...
            main33.duration = 0.05f;
            main33.startLifetime = 0.05f;
            ...
            main34.duration = 0.05f;
            main34.startLifetime = 0.05f;
            ...
            main36.duration = 0.05f;
            main36.startLifetime = 0.05f;
            ...
            main38.duration = 1.50f;
            main38.startLifetime = 1.50f;
            ...
            main39.duration = 1.50f;
            main39.startLifetime = 1.50f;
            ...
            main40.duration = 1.50f;
            main40.startLifetime = 1.50f;
            ...
            main41.duration = 0.05f;
            main41.startLifetime = 0.05f;
            ...
            main42.duration = 0.05f;
            main42.startLifetime = 0.05f;
            ...
            main43.duration = 1.50f;
            main43.startLifetime = 1.50f;
            ...
            main44.duration = 0.05f;
            main44.startLifetime = 0.05f;
            ...
            main49.duration = 0.05f;
            main49.startLifetime = 0.05f;
            ...
            main50.duration = 0.05f;
            main50.startLifetime = 0.05f;
            ...
            main52.duration = 0.05f;
            main52.startLifetime = 0.05f;
            ...
            main57.duration = 4.00f;
            main57.startLifetime = 4.00f;
