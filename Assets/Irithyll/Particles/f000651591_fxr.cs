...
namespace IrithyllParticles
{
    ...
    /// Source: f000651591.fxr
    /// Effect ID: 651591
    /// Generated emitters: 54
    /// </summary>
    public class f000651591_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.50f;
            main2.startLifetime = 0.50f;
            ...
            var main3 = ps3.main;
            main3.duration = 0.50f;
            main3.startLifetime = 0.50f;
            ...
            gradient4.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(0.62f, 0.71f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(0.62f, 0.71f, 1.00f), 1.00f)
                },
            ...
            var main5 = ps5.main;
            main5.duration = 0.10f;
            main5.startLifetime = 0.10f;
            ...
            shape5.shapeType = ParticleSystemShapeType.Box;
            shape5.radius = 0.5f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.30f;
            main8.startLifetime = 0.30f;
            ...
            var main9 = ps9.main;
            main9.duration = 0.30f;
            main9.startLifetime = 0.30f;
            ...
            main12.duration = 0.50f;
            main12.startLifetime = 0.50f;
            ...
            main14.duration = 0.10f;
            main14.startLifetime = 0.10f;
            ...
            // Color over lifetime
            var color14 = ps14.colorOverLifetime;
            color14.enabled = true;
            ...
            main19.duration = 0.30f;
            main19.startLifetime = 0.30f;
            ...
            main21.duration = 0.50f;
            main21.startLifetime = 0.50f;
            ...
            main23.duration = 0.10f;
            main23.startLifetime = 0.10f;
            ...
            shape23.shapeType = ParticleSystemShapeType.Box;
            shape23.radius = 0.5f;
            ...
            main24.duration = 0.10f;
            main24.startLifetime = 0.10f;
            ...
            main30.duration = 0.50f;
            main30.startLifetime = 0.50f;
            ...
            emission32.rateOverTime = 50;

            // Shape
            var shape32 = ps32.shape;
            shape32.shapeType = ParticleSystemShapeType.Box;
            shape32.radius = 0.5f;
            ...
            main33.duration = 0.10f;
            main33.startLifetime = 0.10f;
            ...
            main34.duration = 0.10f;
            main34.startLifetime = 0.10f;
            ...
            main38.duration = 0.50f;
            main38.startLifetime = 0.50f;
            ...
            main40.duration = 0.10f;
            main40.startLifetime = 0.10f;
            ...
            main41.duration = 0.10f;
            main41.startLifetime = 0.10f;
            ...
            main44.duration = 0.30f;
            main44.startLifetime = 0.30f;
            ...
            main47.duration = 0.50f;
            main47.startLifetime = 0.50f;
            ...
            emission48.rateOverTime = 50;

            // Shape
            var shape48 = ps48.shape;
            shape48.shapeType = ParticleSystemShapeType.Box;
            shape48.radius = 0.5f;
            ...
            main49.duration = 0.10f;
            main49.startLifetime = 0.10f;
            ...
            emission49.rateOverTime = 40;

            // Shape
            var shape49 = ps49.shape;
            shape49.shapeType = ParticleSystemShapeType.Box;
            shape49.radius = 0.5f;
            ...
            main50.duration = 0.10f;
            main50.startLifetime = 0.10f;
            ...
            main51.duration = 0.10f;
            main51.startLifetime = 0.10f;
            ...
            main52.duration = 0.30f;
            main52.startLifetime = 0.30f;
