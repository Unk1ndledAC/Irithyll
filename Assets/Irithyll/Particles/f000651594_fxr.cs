...
namespace IrithyllParticles
{
    ...
    /// Source: f000651594.fxr
    /// Effect ID: 651594
    /// Generated emitters: 18
    /// </summary>
    public class f000651594_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main2 = ps2.main;
            main2.duration = 0.13f;
            main2.startLifetime = 0.13f;
            ...
            main14.duration = 0.13f;
            main14.startLifetime = 0.13f;
