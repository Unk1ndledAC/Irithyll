...
namespace IrithyllParticles
{
    ...
    /// Source: f000651595.fxr
    /// Effect ID: 651595
    /// Generated emitters: 6
    /// </summary>
    public class f000651595_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 6.00f;
            main3.startLifetime = 6.00f;
            ...
            var main4 = ps4.main;
            main4.duration = 6.00f;
            main4.startLifetime = 6.00f;
            ...
            var main5 = ps5.main;
            main5.duration = 6.00f;
            main5.startLifetime = 6.00f;
