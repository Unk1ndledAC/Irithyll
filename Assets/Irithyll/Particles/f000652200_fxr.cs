...
namespace IrithyllParticles
{
    ...
    /// Source: f000652200.fxr
    /// Effect ID: 652200
    /// Generated emitters: 15
    /// </summary>
    public class f000652200_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
