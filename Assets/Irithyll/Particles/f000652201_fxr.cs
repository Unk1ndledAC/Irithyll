...
namespace IrithyllParticles
{
    ...
    /// Source: f000652201.fxr
    /// Effect ID: 652201
    /// Generated emitters: 15
    /// </summary>
    public class f000652201_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient3.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.78f, 0.62f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.78f, 0.62f), 1.00f)
                },
