...
namespace IrithyllParticles
{
    ...
    /// Source: f000652202.fxr
    /// Effect ID: 652202
    /// Generated emitters: 21
    /// </summary>
    public class f000652202_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient2.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(0.53f, 0.63f, 0.87f), 0.00f),
                    new GradientColorKey(new Color(0.53f, 0.63f, 0.87f), 1.00f)
                },
