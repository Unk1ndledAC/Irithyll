...
namespace IrithyllParticles
{
    ...
    /// Source: f000652230.fxr
    /// Effect ID: 652230
    /// Generated emitters: 112
    /// </summary>
    public class f000652230_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main11.duration = 4.00f;
            main11.startLifetime = 4.00f;
            ...
            main12.duration = 3.00f;
            main12.startLifetime = 3.00f;
            ...
            main13.duration = 1.83f;
            main13.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color15 = ps15.colorOverLifetime;
            color15.enabled = true;
            ...
            // Color over lifetime
            var color18 = ps18.colorOverLifetime;
            color18.enabled = true;
            ...
            main21.duration = 1.83f;
            main21.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color35 = ps35.colorOverLifetime;
            color35.enabled = true;
            Gradient gradient35 = new Gradient();
            gradient35.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            // Color over lifetime
            var color36 = ps36.colorOverLifetime;
            color36.enabled = true;
            Gradient gradient36 = new Gradient();
            gradient36.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            main42.duration = 4.00f;
            main42.startLifetime = 4.00f;
            ...
            main44.duration = 1.83f;
            main44.startLifetime = 1.83f;
            ...
            main52.duration = 1.83f;
            main52.startLifetime = 1.83f;
            ...
            main73.duration = 1.83f;
            main73.startLifetime = 1.83f;
