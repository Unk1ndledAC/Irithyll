...
namespace IrithyllParticles
{
    ...
    /// Source: f000652231.fxr
    /// Effect ID: 652231
    /// Generated emitters: 133
    /// </summary>
    public class f000652231_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 1.83f;
            main3.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color10 = ps10.colorOverLifetime;
            color10.enabled = true;
            ...
            main11.duration = 2.00f;
            main11.startLifetime = 2.00f;
            ...
            main12.duration = 2.87f;
            main12.startLifetime = 2.87f;
            ...
            main13.duration = 0.20f;
            main13.startLifetime = 0.20f;
            ...
            main14.duration = 0.20f;
            main14.startLifetime = 0.20f;
            ...
            main17.duration = 1.83f;
            main17.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color19 = ps19.colorOverLifetime;
            color19.enabled = true;
            ...
            main25.duration = 1.83f;
            main25.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color30 = ps30.colorOverLifetime;
            color30.enabled = true;
            Gradient gradient30 = new Gradient();
            gradient30.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            // Color over lifetime
            var color43 = ps43.colorOverLifetime;
            color43.enabled = true;
            Gradient gradient43 = new Gradient();
            gradient43.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            main47.duration = 2.87f;
            main47.startLifetime = 2.87f;
            ...
            main48.duration = 0.20f;
            main48.startLifetime = 0.20f;
            ...
            main50.duration = 2.87f;
            main50.startLifetime = 2.87f;
            ...
            main51.duration = 0.20f;
            main51.startLifetime = 0.20f;
            ...
            // Color over lifetime
            var color51 = ps51.colorOverLifetime;
            color51.enabled = true;
            Gradient gradient51 = new Gradient();
            gradient51.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main52.duration = 0.20f;
            main52.startLifetime = 0.20f;
            ...
            main55.duration = 1.83f;
            main55.startLifetime = 1.83f;
            ...
            main63.duration = 1.83f;
            main63.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color70 = ps70.colorOverLifetime;
            color70.enabled = true;
            Gradient gradient70 = new Gradient();
            gradient70.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            main84.duration = 1.83f;
            main84.startLifetime = 1.83f;
            ...
            // Color over lifetime
            var color111 = ps111.colorOverLifetime;
            color111.enabled = true;
            Gradient gradient111 = new Gradient();
            gradient111.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            // Color over lifetime
            var color112 = ps112.colorOverLifetime;
            color112.enabled = true;
            Gradient gradient112 = new Gradient();
            gradient112.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 1.00f, 1.00f), 1.00f)
            ...
            main124.duration = 2.00f;
            main124.startLifetime = 2.00f;
            ...
            main125.duration = 2.87f;
            main125.startLifetime = 2.87f;
            ...
            main126.duration = 0.20f;
            main126.startLifetime = 0.20f;
            ...
            main127.duration = 0.20f;
            main127.startLifetime = 0.20f;
            ...
            main128.duration = 2.87f;
            main128.startLifetime = 2.87f;
            ...
            main129.duration = 0.20f;
            main129.startLifetime = 0.20f;
            ...
            main130.duration = 0.20f;
            main130.startLifetime = 0.20f;
            ...
            main131.duration = 2.87f;
            main131.startLifetime = 2.87f;
            ...
            main132.duration = 0.20f;
            main132.startLifetime = 0.20f;
