...
namespace IrithyllParticles
{
    ...
    /// Source: f000652255.fxr
    /// Effect ID: 652255
    /// Generated emitters: 86
    /// </summary>
    public class f000652255_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 0.80f;
            main5.startLifetime = 0.80f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.07f;
            main7.startLifetime = 0.07f;
            ...
            main17.duration = 1.20f;
            main17.startLifetime = 1.20f;
            ...
            main18.duration = 0.80f;
            main18.startLifetime = 0.80f;
            ...
            main19.duration = 0.80f;
            main19.startLifetime = 0.80f;
            ...
            main20.duration = 0.10f;
            main20.startLifetime = 0.10f;
            ...
            main21.duration = 0.07f;
            main21.startLifetime = 0.07f;
            ...
            main25.duration = 2.00f;
            main25.startLifetime = 2.00f;
            ...
            main28.duration = 0.80f;
            main28.startLifetime = 0.80f;
            ...
            main29.duration = 1.20f;
            main29.startLifetime = 1.20f;
            ...
            main30.duration = 0.80f;
            main30.startLifetime = 0.80f;
            ...
            main33.duration = 0.07f;
            main33.startLifetime = 0.07f;
            ...
            main43.duration = 4.00f;
            main43.startLifetime = 4.00f;
            ...
            main45.duration = 1.20f;
            main45.startLifetime = 1.20f;
            ...
            main46.duration = 0.80f;
            main46.startLifetime = 0.80f;
            ...
            main47.duration = 0.80f;
            main47.startLifetime = 0.80f;
            ...
            main49.duration = 0.07f;
            main49.startLifetime = 0.07f;
            ...
            main56.duration = 0.80f;
            main56.startLifetime = 0.80f;
            ...
            main57.duration = 1.20f;
            main57.startLifetime = 1.20f;
            ...
            main58.duration = 0.80f;
            main58.startLifetime = 0.80f;
            ...
            main59.duration = 0.80f;
            main59.startLifetime = 0.80f;
            ...
            main61.duration = 0.07f;
            main61.startLifetime = 0.07f;
            ...
            main62.duration = 0.10f;
            main62.startLifetime = 0.10f;
            ...
            main70.duration = 0.80f;
            main70.startLifetime = 0.80f;
            ...
            main71.duration = 1.20f;
            main71.startLifetime = 1.20f;
            ...
            main72.duration = 0.80f;
            main72.startLifetime = 0.80f;
            ...
            main75.duration = 0.07f;
            main75.startLifetime = 0.07f;
            ...
            main76.duration = 0.10f;
            main76.startLifetime = 0.10f;
            ...
            main77.duration = 0.10f;
            main77.startLifetime = 0.10f;
            ...
            main84.duration = 2.00f;
            main84.startLifetime = 2.00f;
