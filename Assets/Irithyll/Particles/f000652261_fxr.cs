...
namespace IrithyllParticles
{
    ...
    /// Source: f000652261.fxr
    /// Effect ID: 652261
    /// Generated emitters: 52
    /// </summary>
    public class f000652261_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main8 = ps8.main;
            main8.duration = 0.33f;
            main8.startLifetime = 0.33f;
            ...
            main17.duration = 0.33f;
            main17.startLifetime = 0.33f;
            ...
            main24.duration = 0.33f;
            main24.startLifetime = 0.33f;
            ...
            main25.duration = 0.33f;
            main25.startLifetime = 0.33f;
            ...
            main34.duration = 0.33f;
            main34.startLifetime = 0.33f;
            ...
            main49.duration = 0.33f;
            main49.startLifetime = 0.33f;
