...
namespace IrithyllParticles
{
    ...
    /// Source: f000652400.fxr
    /// Effect ID: 652400
    /// Generated emitters: 248
    /// </summary>
    public class f000652400_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            // Color over lifetime
            var color5 = ps5.colorOverLifetime;
            color5.enabled = true;
            Gradient gradient5 = new Gradient();
            gradient5.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
                },
            ...
            // Color over lifetime
            var color6 = ps6.colorOverLifetime;
            color6.enabled = true;
            ...
            // Color over lifetime
            var color7 = ps7.colorOverLifetime;
            color7.enabled = true;
            ...
            // Color over lifetime
            var color8 = ps8.colorOverLifetime;
            color8.enabled = true;
            ...
            main20.duration = 3.00f;
            main20.startLifetime = 3.00f;
            ...
            main21.duration = 3.00f;
            main21.startLifetime = 3.00f;
            ...
            main22.duration = 2.00f;
            main22.startLifetime = 2.00f;
            ...
            // Color over lifetime
            var color26 = ps26.colorOverLifetime;
            color26.enabled = true;
            Gradient gradient26 = new Gradient();
            gradient26.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color27 = ps27.colorOverLifetime;
            color27.enabled = true;
            Gradient gradient27 = new Gradient();
            gradient27.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color28 = ps28.colorOverLifetime;
            color28.enabled = true;
            Gradient gradient28 = new Gradient();
            gradient28.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color29 = ps29.colorOverLifetime;
            color29.enabled = true;
            Gradient gradient29 = new Gradient();
            gradient29.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main39.duration = 3.00f;
            main39.startLifetime = 3.00f;
            ...
            main40.duration = 3.00f;
            main40.startLifetime = 3.00f;
            ...
            main41.duration = 3.00f;
            main41.startLifetime = 3.00f;
            ...
            main42.duration = 3.00f;
            main42.startLifetime = 3.00f;
            ...
            // Color over lifetime
            var color46 = ps46.colorOverLifetime;
            color46.enabled = true;
            Gradient gradient46 = new Gradient();
            gradient46.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color47 = ps47.colorOverLifetime;
            color47.enabled = true;
            Gradient gradient47 = new Gradient();
            gradient47.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color48 = ps48.colorOverLifetime;
            color48.enabled = true;
            Gradient gradient48 = new Gradient();
            gradient48.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color49 = ps49.colorOverLifetime;
            color49.enabled = true;
            Gradient gradient49 = new Gradient();
            gradient49.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color61 = ps61.colorOverLifetime;
            color61.enabled = true;
            Gradient gradient61 = new Gradient();
            gradient61.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color62 = ps62.colorOverLifetime;
            color62.enabled = true;
            Gradient gradient62 = new Gradient();
            gradient62.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color63 = ps63.colorOverLifetime;
            color63.enabled = true;
            Gradient gradient63 = new Gradient();
            gradient63.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color64 = ps64.colorOverLifetime;
            color64.enabled = true;
            Gradient gradient64 = new Gradient();
            gradient64.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color74 = ps74.colorOverLifetime;
            color74.enabled = true;
            Gradient gradient74 = new Gradient();
            gradient74.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color75 = ps75.colorOverLifetime;
            color75.enabled = true;
            Gradient gradient75 = new Gradient();
            gradient75.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main76.duration = 0.03f;
            main76.startLifetime = 0.03f;
            ...
            // Color over lifetime
            var color76 = ps76.colorOverLifetime;
            color76.enabled = true;
            Gradient gradient76 = new Gradient();
            gradient76.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main77.duration = 0.03f;
            main77.startLifetime = 0.03f;
            ...
            // Color over lifetime
            var color77 = ps77.colorOverLifetime;
            color77.enabled = true;
            Gradient gradient77 = new Gradient();
            gradient77.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main78.duration = 0.03f;
            main78.startLifetime = 0.03f;
            ...
            main87.duration = 3.00f;
            main87.startLifetime = 3.00f;
            ...
            main89.duration = 3.00f;
            main89.startLifetime = 3.00f;
            ...
            main90.duration = 3.00f;
            main90.startLifetime = 3.00f;
            ...
            main91.duration = 2.00f;
            main91.startLifetime = 2.00f;
            ...
            main95.duration = 0.03f;
            main95.startLifetime = 0.03f;
            ...
            // Color over lifetime
            var color95 = ps95.colorOverLifetime;
            color95.enabled = true;
            Gradient gradient95 = new Gradient();
            gradient95.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main96.duration = 0.03f;
            main96.startLifetime = 0.03f;
            ...
            // Color over lifetime
            var color96 = ps96.colorOverLifetime;
            color96.enabled = true;
            Gradient gradient96 = new Gradient();
            gradient96.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color97 = ps97.colorOverLifetime;
            color97.enabled = true;
            Gradient gradient97 = new Gradient();
            gradient97.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color98 = ps98.colorOverLifetime;
            color98.enabled = true;
            Gradient gradient98 = new Gradient();
            gradient98.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main108.duration = 3.00f;
            main108.startLifetime = 3.00f;
            ...
            main109.duration = 3.00f;
            main109.startLifetime = 3.00f;
            ...
            main110.duration = 3.00f;
            main110.startLifetime = 3.00f;
            ...
            main111.duration = 3.00f;
            main111.startLifetime = 3.00f;
            ...
            // Color over lifetime
            var color115 = ps115.colorOverLifetime;
            color115.enabled = true;
            Gradient gradient115 = new Gradient();
            gradient115.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color116 = ps116.colorOverLifetime;
            color116.enabled = true;
            Gradient gradient116 = new Gradient();
            gradient116.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color117 = ps117.colorOverLifetime;
            color117.enabled = true;
            Gradient gradient117 = new Gradient();
            gradient117.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color118 = ps118.colorOverLifetime;
            color118.enabled = true;
            Gradient gradient118 = new Gradient();
            gradient118.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color130 = ps130.colorOverLifetime;
            color130.enabled = true;
            Gradient gradient130 = new Gradient();
            gradient130.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color131 = ps131.colorOverLifetime;
            color131.enabled = true;
            Gradient gradient131 = new Gradient();
            gradient131.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color132 = ps132.colorOverLifetime;
            color132.enabled = true;
            Gradient gradient132 = new Gradient();
            gradient132.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color133 = ps133.colorOverLifetime;
            color133.enabled = true;
            Gradient gradient133 = new Gradient();
            gradient133.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main134.duration = 0.03f;
            main134.startLifetime = 0.03f;
            ...
            main135.duration = 0.03f;
            main135.startLifetime = 0.03f;
            ...
            // Color over lifetime
            var color143 = ps143.colorOverLifetime;
            color143.enabled = true;
            Gradient gradient143 = new Gradient();
            gradient143.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color144 = ps144.colorOverLifetime;
            color144.enabled = true;
            Gradient gradient144 = new Gradient();
            gradient144.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color145 = ps145.colorOverLifetime;
            color145.enabled = true;
            Gradient gradient145 = new Gradient();
            gradient145.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color146 = ps146.colorOverLifetime;
            color146.enabled = true;
            Gradient gradient146 = new Gradient();
            gradient146.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main156.duration = 3.00f;
            main156.startLifetime = 3.00f;
            ...
            main157.duration = 3.00f;
            main157.startLifetime = 3.00f;
            ...
            main158.duration = 3.00f;
            main158.startLifetime = 3.00f;
            ...
            main159.duration = 3.00f;
            main159.startLifetime = 3.00f;
            ...
            // Color over lifetime
            var color163 = ps163.colorOverLifetime;
            color163.enabled = true;
            Gradient gradient163 = new Gradient();
            gradient163.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color164 = ps164.colorOverLifetime;
            color164.enabled = true;
            Gradient gradient164 = new Gradient();
            gradient164.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color165 = ps165.colorOverLifetime;
            color165.enabled = true;
            Gradient gradient165 = new Gradient();
            gradient165.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color166 = ps166.colorOverLifetime;
            color166.enabled = true;
            Gradient gradient166 = new Gradient();
            gradient166.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color178 = ps178.colorOverLifetime;
            color178.enabled = true;
            Gradient gradient178 = new Gradient();
            gradient178.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color179 = ps179.colorOverLifetime;
            color179.enabled = true;
            Gradient gradient179 = new Gradient();
            gradient179.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color180 = ps180.colorOverLifetime;
            color180.enabled = true;
            Gradient gradient180 = new Gradient();
            gradient180.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color181 = ps181.colorOverLifetime;
            color181.enabled = true;
            Gradient gradient181 = new Gradient();
            gradient181.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color191 = ps191.colorOverLifetime;
            color191.enabled = true;
            Gradient gradient191 = new Gradient();
            gradient191.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color192 = ps192.colorOverLifetime;
            color192.enabled = true;
            Gradient gradient192 = new Gradient();
            gradient192.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color193 = ps193.colorOverLifetime;
            color193.enabled = true;
            Gradient gradient193 = new Gradient();
            gradient193.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            // Color over lifetime
            var color194 = ps194.colorOverLifetime;
            color194.enabled = true;
            Gradient gradient194 = new Gradient();
            gradient194.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            main202.duration = 0.03f;
            main202.startLifetime = 0.03f;
            ...
            main203.duration = 0.03f;
            main203.startLifetime = 0.03f;
            ...
            // Emitter 204: Emitter_1004
            GameObject emitter204 = new GameObject("Emitter_204");
            emitter204.transform.SetParent(transform);
            emitter204.transform.localPosition = Vector3.zero;

            ParticleSystem ps204 = emitter204.AddComponent<ParticleSystem>();
            var main204 = ps204.main;
            main204.duration = 0.03f;
            main204.startLifetime = 0.03f;
            main204.startSpeed = 1.00f;
            main204.startSize = 0.100f;
            main204.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission204 = ps204.emission;
            emission204.rateOverTime = 3;

            // Shape
            var shape204 = ps204.shape;
            shape204.shapeType = ParticleSystemShapeType.Sphere;
            shape204.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer204 = emitter204.GetComponent<ParticleSystemRenderer>();
            renderer204.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 205: Emitter_1004
            GameObject emitter205 = new GameObject("Emitter_205");
            emitter205.transform.SetParent(transform);
            emitter205.transform.localPosition = Vector3.zero;

            ParticleSystem ps205 = emitter205.AddComponent<ParticleSystem>();
            var main205 = ps205.main;
            main205.duration = 0.03f;
            main205.startLifetime = 0.03f;
            main205.startSpeed = 1.00f;
            main205.startSize = 0.100f;
            main205.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission205 = ps205.emission;
            emission205.rateOverTime = 3;

            // Shape
            var shape205 = ps205.shape;
            shape205.shapeType = ParticleSystemShapeType.Sphere;
            shape205.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer205 = emitter205.GetComponent<ParticleSystemRenderer>();
            renderer205.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 206: Emitter_1004
            GameObject emitter206 = new GameObject("Emitter_206");
            emitter206.transform.SetParent(transform);
            emitter206.transform.localPosition = Vector3.zero;

            ParticleSystem ps206 = emitter206.AddComponent<ParticleSystem>();
            var main206 = ps206.main;
            main206.duration = 0.03f;
            main206.startLifetime = 0.03f;
            main206.startSpeed = 1.00f;
            main206.startSize = 0.100f;
            main206.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission206 = ps206.emission;
            emission206.rateOverTime = 160;

            // Shape
            var shape206 = ps206.shape;
            shape206.shapeType = ParticleSystemShapeType.Sphere;
            shape206.radius = 0.5f;

            // Color over lifetime
            var color206 = ps206.colorOverLifetime;
            color206.enabled = true;
            Gradient gradient206 = new Gradient();
            gradient206.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color206.color = gradient206;

            // Renderer
            ParticleSystemRenderer renderer206 = emitter206.GetComponent<ParticleSystemRenderer>();
            renderer206.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 207: Emitter_1004
            GameObject emitter207 = new GameObject("Emitter_207");
            emitter207.transform.SetParent(transform);
            emitter207.transform.localPosition = Vector3.zero;

            ParticleSystem ps207 = emitter207.AddComponent<ParticleSystem>();
            var main207 = ps207.main;
            main207.duration = 0.03f;
            main207.startLifetime = 0.03f;
            main207.startSpeed = 1.00f;
            main207.startSize = 0.100f;
            main207.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission207 = ps207.emission;
            emission207.rateOverTime = 160;

            // Shape
            var shape207 = ps207.shape;
            shape207.shapeType = ParticleSystemShapeType.Sphere;
            shape207.radius = 0.5f;

            // Color over lifetime
            var color207 = ps207.colorOverLifetime;
            color207.enabled = true;
            Gradient gradient207 = new Gradient();
            gradient207.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color207.color = gradient207;

            // Renderer
            ParticleSystemRenderer renderer207 = emitter207.GetComponent<ParticleSystemRenderer>();
            renderer207.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 208: Emitter_1004
            GameObject emitter208 = new GameObject("Emitter_208");
            emitter208.transform.SetParent(transform);
            emitter208.transform.localPosition = Vector3.zero;

            ParticleSystem ps208 = emitter208.AddComponent<ParticleSystem>();
            var main208 = ps208.main;
            main208.duration = 0.03f;
            main208.startLifetime = 0.03f;
            main208.startSpeed = 1.00f;
            main208.startSize = 0.100f;
            main208.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission208 = ps208.emission;
            emission208.rateOverTime = 160;

            // Shape
            var shape208 = ps208.shape;
            shape208.shapeType = ParticleSystemShapeType.Sphere;
            shape208.radius = 0.5f;

            // Color over lifetime
            var color208 = ps208.colorOverLifetime;
            color208.enabled = true;
            Gradient gradient208 = new Gradient();
            gradient208.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color208.color = gradient208;

            // Renderer
            ParticleSystemRenderer renderer208 = emitter208.GetComponent<ParticleSystemRenderer>();
            renderer208.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 209: Emitter_1004
            GameObject emitter209 = new GameObject("Emitter_209");
            emitter209.transform.SetParent(transform);
            emitter209.transform.localPosition = Vector3.zero;

            ParticleSystem ps209 = emitter209.AddComponent<ParticleSystem>();
            var main209 = ps209.main;
            main209.duration = 0.03f;
            main209.startLifetime = 0.03f;
            main209.startSpeed = 1.00f;
            main209.startSize = 0.100f;
            main209.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission209 = ps209.emission;
            emission209.rateOverTime = 160;

            // Shape
            var shape209 = ps209.shape;
            shape209.shapeType = ParticleSystemShapeType.Sphere;
            shape209.radius = 0.5f;

            // Color over lifetime
            var color209 = ps209.colorOverLifetime;
            color209.enabled = true;
            Gradient gradient209 = new Gradient();
            gradient209.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color209.color = gradient209;

            // Renderer
            ParticleSystemRenderer renderer209 = emitter209.GetComponent<ParticleSystemRenderer>();
            renderer209.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 210: Emitter_1004
            GameObject emitter210 = new GameObject("Emitter_210");
            emitter210.transform.SetParent(transform);
            emitter210.transform.localPosition = Vector3.zero;

            ParticleSystem ps210 = emitter210.AddComponent<ParticleSystem>();
            var main210 = ps210.main;
            main210.duration = 0.03f;
            main210.startLifetime = 0.03f;
            main210.startSpeed = 1.00f;
            main210.startSize = 0.100f;
            main210.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission210 = ps210.emission;
            emission210.rateOverTime = 3;

            // Shape
            var shape210 = ps210.shape;
            shape210.shapeType = ParticleSystemShapeType.Sphere;
            shape210.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer210 = emitter210.GetComponent<ParticleSystemRenderer>();
            renderer210.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 211: Emitter_1004
            GameObject emitter211 = new GameObject("Emitter_211");
            emitter211.transform.SetParent(transform);
            emitter211.transform.localPosition = Vector3.zero;

            ParticleSystem ps211 = emitter211.AddComponent<ParticleSystem>();
            var main211 = ps211.main;
            main211.duration = 0.03f;
            main211.startLifetime = 0.03f;
            main211.startSpeed = 1.00f;
            main211.startSize = 0.100f;
            main211.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission211 = ps211.emission;
            emission211.rateOverTime = 3;

            // Shape
            var shape211 = ps211.shape;
            shape211.shapeType = ParticleSystemShapeType.Sphere;
            shape211.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer211 = emitter211.GetComponent<ParticleSystemRenderer>();
            renderer211.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 212: Emitter_1004
            GameObject emitter212 = new GameObject("Emitter_212");
            emitter212.transform.SetParent(transform);
            emitter212.transform.localPosition = Vector3.zero;

            ParticleSystem ps212 = emitter212.AddComponent<ParticleSystem>();
            var main212 = ps212.main;
            main212.duration = 0.03f;
            main212.startLifetime = 0.03f;
            main212.startSpeed = 1.00f;
            main212.startSize = 0.100f;
            main212.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission212 = ps212.emission;
            emission212.rateOverTime = 3;

            // Shape
            var shape212 = ps212.shape;
            shape212.shapeType = ParticleSystemShapeType.Sphere;
            shape212.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer212 = emitter212.GetComponent<ParticleSystemRenderer>();
            renderer212.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 213: Emitter_1004
            GameObject emitter213 = new GameObject("Emitter_213");
            emitter213.transform.SetParent(transform);
            emitter213.transform.localPosition = Vector3.zero;

            ParticleSystem ps213 = emitter213.AddComponent<ParticleSystem>();
            var main213 = ps213.main;
            main213.duration = 0.03f;
            main213.startLifetime = 0.03f;
            main213.startSpeed = 1.00f;
            main213.startSize = 0.100f;
            main213.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission213 = ps213.emission;
            emission213.rateOverTime = 3;

            // Shape
            var shape213 = ps213.shape;
            shape213.shapeType = ParticleSystemShapeType.Sphere;
            shape213.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer213 = emitter213.GetComponent<ParticleSystemRenderer>();
            renderer213.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 214: Emitter_1004
            GameObject emitter214 = new GameObject("Emitter_214");
            emitter214.transform.SetParent(transform);
            emitter214.transform.localPosition = Vector3.zero;

            ParticleSystem ps214 = emitter214.AddComponent<ParticleSystem>();
            var main214 = ps214.main;
            main214.duration = 0.03f;
            main214.startLifetime = 0.03f;
            main214.startSpeed = 1.00f;
            main214.startSize = 0.100f;
            main214.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission214 = ps214.emission;
            emission214.rateOverTime = 3;

            // Shape
            var shape214 = ps214.shape;
            shape214.shapeType = ParticleSystemShapeType.Sphere;
            shape214.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer214 = emitter214.GetComponent<ParticleSystemRenderer>();
            renderer214.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 215: Emitter_1004
            GameObject emitter215 = new GameObject("Emitter_215");
            emitter215.transform.SetParent(transform);
            emitter215.transform.localPosition = Vector3.zero;

            ParticleSystem ps215 = emitter215.AddComponent<ParticleSystem>();
            var main215 = ps215.main;
            main215.duration = 0.03f;
            main215.startLifetime = 0.03f;
            main215.startSpeed = 1.00f;
            main215.startSize = 0.100f;
            main215.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission215 = ps215.emission;
            emission215.rateOverTime = 3;

            // Shape
            var shape215 = ps215.shape;
            shape215.shapeType = ParticleSystemShapeType.Sphere;
            shape215.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer215 = emitter215.GetComponent<ParticleSystemRenderer>();
            renderer215.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 216: Emitter_1004
            GameObject emitter216 = new GameObject("Emitter_216");
            emitter216.transform.SetParent(transform);
            emitter216.transform.localPosition = Vector3.zero;

            ParticleSystem ps216 = emitter216.AddComponent<ParticleSystem>();
            var main216 = ps216.main;
            main216.duration = 0.03f;
            main216.startLifetime = 0.03f;
            main216.startSpeed = 1.00f;
            main216.startSize = 0.100f;
            main216.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission216 = ps216.emission;
            emission216.rateOverTime = 3;

            // Shape
            var shape216 = ps216.shape;
            shape216.shapeType = ParticleSystemShapeType.Sphere;
            shape216.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer216 = emitter216.GetComponent<ParticleSystemRenderer>();
            renderer216.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 217: Emitter_1004
            GameObject emitter217 = new GameObject("Emitter_217");
            emitter217.transform.SetParent(transform);
            emitter217.transform.localPosition = Vector3.zero;

            ParticleSystem ps217 = emitter217.AddComponent<ParticleSystem>();
            var main217 = ps217.main;
            main217.duration = 0.03f;
            main217.startLifetime = 0.03f;
            main217.startSpeed = 1.00f;
            main217.startSize = 0.100f;
            main217.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission217 = ps217.emission;
            emission217.rateOverTime = 3;

            // Shape
            var shape217 = ps217.shape;
            shape217.shapeType = ParticleSystemShapeType.Sphere;
            shape217.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer217 = emitter217.GetComponent<ParticleSystemRenderer>();
            renderer217.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 218: Emitter_1004
            GameObject emitter218 = new GameObject("Emitter_218");
            emitter218.transform.SetParent(transform);
            emitter218.transform.localPosition = Vector3.zero;

            ParticleSystem ps218 = emitter218.AddComponent<ParticleSystem>();
            var main218 = ps218.main;
            main218.duration = 0.03f;
            main218.startLifetime = 0.03f;
            main218.startSpeed = 1.00f;
            main218.startSize = 0.100f;
            main218.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission218 = ps218.emission;
            emission218.rateOverTime = 3;

            // Shape
            var shape218 = ps218.shape;
            shape218.shapeType = ParticleSystemShapeType.Sphere;
            shape218.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer218 = emitter218.GetComponent<ParticleSystemRenderer>();
            renderer218.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 219: Emitter_1004
            GameObject emitter219 = new GameObject("Emitter_219");
            emitter219.transform.SetParent(transform);
            emitter219.transform.localPosition = Vector3.zero;

            ParticleSystem ps219 = emitter219.AddComponent<ParticleSystem>();
            var main219 = ps219.main;
            main219.duration = 0.03f;
            main219.startLifetime = 0.03f;
            main219.startSpeed = 1.00f;
            main219.startSize = 0.100f;
            main219.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission219 = ps219.emission;
            emission219.rateOverTime = 160;

            // Shape
            var shape219 = ps219.shape;
            shape219.shapeType = ParticleSystemShapeType.Sphere;
            shape219.radius = 0.5f;

            // Color over lifetime
            var color219 = ps219.colorOverLifetime;
            color219.enabled = true;
            Gradient gradient219 = new Gradient();
            gradient219.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color219.color = gradient219;

            // Renderer
            ParticleSystemRenderer renderer219 = emitter219.GetComponent<ParticleSystemRenderer>();
            renderer219.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 220: Emitter_1004
            GameObject emitter220 = new GameObject("Emitter_220");
            emitter220.transform.SetParent(transform);
            emitter220.transform.localPosition = Vector3.zero;

            ParticleSystem ps220 = emitter220.AddComponent<ParticleSystem>();
            var main220 = ps220.main;
            main220.duration = 0.03f;
            main220.startLifetime = 0.03f;
            main220.startSpeed = 1.00f;
            main220.startSize = 0.100f;
            main220.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission220 = ps220.emission;
            emission220.rateOverTime = 160;

            // Shape
            var shape220 = ps220.shape;
            shape220.shapeType = ParticleSystemShapeType.Sphere;
            shape220.radius = 0.5f;

            // Color over lifetime
            var color220 = ps220.colorOverLifetime;
            color220.enabled = true;
            Gradient gradient220 = new Gradient();
            gradient220.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color220.color = gradient220;

            // Renderer
            ParticleSystemRenderer renderer220 = emitter220.GetComponent<ParticleSystemRenderer>();
            renderer220.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 221: Emitter_1004
            GameObject emitter221 = new GameObject("Emitter_221");
            emitter221.transform.SetParent(transform);
            emitter221.transform.localPosition = Vector3.zero;

            ParticleSystem ps221 = emitter221.AddComponent<ParticleSystem>();
            var main221 = ps221.main;
            main221.duration = 0.03f;
            main221.startLifetime = 0.03f;
            main221.startSpeed = 1.00f;
            main221.startSize = 0.100f;
            main221.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission221 = ps221.emission;
            emission221.rateOverTime = 160;

            // Shape
            var shape221 = ps221.shape;
            shape221.shapeType = ParticleSystemShapeType.Sphere;
            shape221.radius = 0.5f;

            // Color over lifetime
            var color221 = ps221.colorOverLifetime;
            color221.enabled = true;
            Gradient gradient221 = new Gradient();
            gradient221.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color221.color = gradient221;

            // Renderer
            ParticleSystemRenderer renderer221 = emitter221.GetComponent<ParticleSystemRenderer>();
            renderer221.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 222: Emitter_1004
            GameObject emitter222 = new GameObject("Emitter_222");
            emitter222.transform.SetParent(transform);
            emitter222.transform.localPosition = Vector3.zero;

            ParticleSystem ps222 = emitter222.AddComponent<ParticleSystem>();
            var main222 = ps222.main;
            main222.duration = 0.03f;
            main222.startLifetime = 0.03f;
            main222.startSpeed = 1.00f;
            main222.startSize = 0.100f;
            main222.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission222 = ps222.emission;
            emission222.rateOverTime = 160;

            // Shape
            var shape222 = ps222.shape;
            shape222.shapeType = ParticleSystemShapeType.Sphere;
            shape222.radius = 0.5f;

            // Color over lifetime
            var color222 = ps222.colorOverLifetime;
            color222.enabled = true;
            Gradient gradient222 = new Gradient();
            gradient222.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color222.color = gradient222;

            // Renderer
            ParticleSystemRenderer renderer222 = emitter222.GetComponent<ParticleSystemRenderer>();
            renderer222.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 223: Emitter_1004
            GameObject emitter223 = new GameObject("Emitter_223");
            emitter223.transform.SetParent(transform);
            emitter223.transform.localPosition = Vector3.zero;

            ParticleSystem ps223 = emitter223.AddComponent<ParticleSystem>();
            var main223 = ps223.main;
            main223.duration = 0.03f;
            main223.startLifetime = 0.03f;
            main223.startSpeed = 1.00f;
            main223.startSize = 0.100f;
            main223.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission223 = ps223.emission;
            emission223.rateOverTime = 3;

            // Shape
            var shape223 = ps223.shape;
            shape223.shapeType = ParticleSystemShapeType.Sphere;
            shape223.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer223 = emitter223.GetComponent<ParticleSystemRenderer>();
            renderer223.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 224: Emitter_1004
            GameObject emitter224 = new GameObject("Emitter_224");
            emitter224.transform.SetParent(transform);
            emitter224.transform.localPosition = Vector3.zero;

            ParticleSystem ps224 = emitter224.AddComponent<ParticleSystem>();
            var main224 = ps224.main;
            main224.duration = 0.03f;
            main224.startLifetime = 0.03f;
            main224.startSpeed = 1.00f;
            main224.startSize = 0.100f;
            main224.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission224 = ps224.emission;
            emission224.rateOverTime = 3;

            // Shape
            var shape224 = ps224.shape;
            shape224.shapeType = ParticleSystemShapeType.Sphere;
            shape224.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer224 = emitter224.GetComponent<ParticleSystemRenderer>();
            renderer224.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 225: Emitter_1004
            GameObject emitter225 = new GameObject("Emitter_225");
            emitter225.transform.SetParent(transform);
            emitter225.transform.localPosition = Vector3.zero;

            ParticleSystem ps225 = emitter225.AddComponent<ParticleSystem>();
            var main225 = ps225.main;
            main225.duration = 0.03f;
            main225.startLifetime = 0.03f;
            main225.startSpeed = 1.00f;
            main225.startSize = 0.100f;
            main225.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission225 = ps225.emission;
            emission225.rateOverTime = 3;

            // Shape
            var shape225 = ps225.shape;
            shape225.shapeType = ParticleSystemShapeType.Sphere;
            shape225.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer225 = emitter225.GetComponent<ParticleSystemRenderer>();
            renderer225.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 226: Emitter_1004
            GameObject emitter226 = new GameObject("Emitter_226");
            emitter226.transform.SetParent(transform);
            emitter226.transform.localPosition = Vector3.zero;

            ParticleSystem ps226 = emitter226.AddComponent<ParticleSystem>();
            var main226 = ps226.main;
            main226.duration = 0.03f;
            main226.startLifetime = 0.03f;
            main226.startSpeed = 1.00f;
            main226.startSize = 0.100f;
            main226.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission226 = ps226.emission;
            emission226.rateOverTime = 3;

            // Shape
            var shape226 = ps226.shape;
            shape226.shapeType = ParticleSystemShapeType.Sphere;
            shape226.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer226 = emitter226.GetComponent<ParticleSystemRenderer>();
            renderer226.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 227: Emitter_1004
            GameObject emitter227 = new GameObject("Emitter_227");
            emitter227.transform.SetParent(transform);
            emitter227.transform.localPosition = Vector3.zero;

            ParticleSystem ps227 = emitter227.AddComponent<ParticleSystem>();
            var main227 = ps227.main;
            main227.duration = 0.03f;
            main227.startLifetime = 0.03f;
            main227.startSpeed = 1.00f;
            main227.startSize = 0.100f;
            main227.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission227 = ps227.emission;
            emission227.rateOverTime = 3;

            // Shape
            var shape227 = ps227.shape;
            shape227.shapeType = ParticleSystemShapeType.Sphere;
            shape227.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer227 = emitter227.GetComponent<ParticleSystemRenderer>();
            renderer227.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 228: Emitter_1004
            GameObject emitter228 = new GameObject("Emitter_228");
            emitter228.transform.SetParent(transform);
            emitter228.transform.localPosition = Vector3.zero;

            ParticleSystem ps228 = emitter228.AddComponent<ParticleSystem>();
            var main228 = ps228.main;
            main228.duration = 0.03f;
            main228.startLifetime = 0.03f;
            main228.startSpeed = 1.00f;
            main228.startSize = 0.100f;
            main228.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission228 = ps228.emission;
            emission228.rateOverTime = 3;

            // Shape
            var shape228 = ps228.shape;
            shape228.shapeType = ParticleSystemShapeType.Sphere;
            shape228.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer228 = emitter228.GetComponent<ParticleSystemRenderer>();
            renderer228.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 229: Emitter_1004
            GameObject emitter229 = new GameObject("Emitter_229");
            emitter229.transform.SetParent(transform);
            emitter229.transform.localPosition = Vector3.zero;

            ParticleSystem ps229 = emitter229.AddComponent<ParticleSystem>();
            var main229 = ps229.main;
            main229.duration = 0.03f;
            main229.startLifetime = 0.03f;
            main229.startSpeed = 1.00f;
            main229.startSize = 0.100f;
            main229.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission229 = ps229.emission;
            emission229.rateOverTime = 3;

            // Shape
            var shape229 = ps229.shape;
            shape229.shapeType = ParticleSystemShapeType.Sphere;
            shape229.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer229 = emitter229.GetComponent<ParticleSystemRenderer>();
            renderer229.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 230: Emitter_1004
            GameObject emitter230 = new GameObject("Emitter_230");
            emitter230.transform.SetParent(transform);
            emitter230.transform.localPosition = Vector3.zero;

            ParticleSystem ps230 = emitter230.AddComponent<ParticleSystem>();
            var main230 = ps230.main;
            main230.duration = 0.03f;
            main230.startLifetime = 0.03f;
            main230.startSpeed = 1.00f;
            main230.startSize = 0.100f;
            main230.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission230 = ps230.emission;
            emission230.rateOverTime = 3;

            // Shape
            var shape230 = ps230.shape;
            shape230.shapeType = ParticleSystemShapeType.Sphere;
            shape230.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer230 = emitter230.GetComponent<ParticleSystemRenderer>();
            renderer230.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 231: Emitter_1004
            GameObject emitter231 = new GameObject("Emitter_231");
            emitter231.transform.SetParent(transform);
            emitter231.transform.localPosition = Vector3.zero;

            ParticleSystem ps231 = emitter231.AddComponent<ParticleSystem>();
            var main231 = ps231.main;
            main231.duration = 0.03f;
            main231.startLifetime = 0.03f;
            main231.startSpeed = 1.00f;
            main231.startSize = 0.100f;
            main231.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission231 = ps231.emission;
            emission231.rateOverTime = 3;

            // Shape
            var shape231 = ps231.shape;
            shape231.shapeType = ParticleSystemShapeType.Sphere;
            shape231.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer231 = emitter231.GetComponent<ParticleSystemRenderer>();
            renderer231.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 232: Emitter_1004
            GameObject emitter232 = new GameObject("Emitter_232");
            emitter232.transform.SetParent(transform);
            emitter232.transform.localPosition = Vector3.zero;

            ParticleSystem ps232 = emitter232.AddComponent<ParticleSystem>();
            var main232 = ps232.main;
            main232.duration = 0.03f;
            main232.startLifetime = 0.03f;
            main232.startSpeed = 1.00f;
            main232.startSize = 0.100f;
            main232.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission232 = ps232.emission;
            emission232.rateOverTime = 160;

            // Shape
            var shape232 = ps232.shape;
            shape232.shapeType = ParticleSystemShapeType.Sphere;
            shape232.radius = 0.5f;

            // Color over lifetime
            var color232 = ps232.colorOverLifetime;
            color232.enabled = true;
            Gradient gradient232 = new Gradient();
            gradient232.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color232.color = gradient232;

            // Renderer
            ParticleSystemRenderer renderer232 = emitter232.GetComponent<ParticleSystemRenderer>();
            renderer232.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 233: Emitter_1004
            GameObject emitter233 = new GameObject("Emitter_233");
            emitter233.transform.SetParent(transform);
            emitter233.transform.localPosition = Vector3.zero;

            ParticleSystem ps233 = emitter233.AddComponent<ParticleSystem>();
            var main233 = ps233.main;
            main233.duration = 0.03f;
            main233.startLifetime = 0.03f;
            main233.startSpeed = 1.00f;
            main233.startSize = 0.100f;
            main233.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission233 = ps233.emission;
            emission233.rateOverTime = 160;

            // Shape
            var shape233 = ps233.shape;
            shape233.shapeType = ParticleSystemShapeType.Sphere;
            shape233.radius = 0.5f;

            // Color over lifetime
            var color233 = ps233.colorOverLifetime;
            color233.enabled = true;
            Gradient gradient233 = new Gradient();
            gradient233.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color233.color = gradient233;

            // Renderer
            ParticleSystemRenderer renderer233 = emitter233.GetComponent<ParticleSystemRenderer>();
            renderer233.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 234: Emitter_1004
            GameObject emitter234 = new GameObject("Emitter_234");
            emitter234.transform.SetParent(transform);
            emitter234.transform.localPosition = Vector3.zero;

            ParticleSystem ps234 = emitter234.AddComponent<ParticleSystem>();
            var main234 = ps234.main;
            main234.duration = 0.03f;
            main234.startLifetime = 0.03f;
            main234.startSpeed = 1.00f;
            main234.startSize = 0.100f;
            main234.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission234 = ps234.emission;
            emission234.rateOverTime = 160;

            // Shape
            var shape234 = ps234.shape;
            shape234.shapeType = ParticleSystemShapeType.Sphere;
            shape234.radius = 0.5f;

            // Color over lifetime
            var color234 = ps234.colorOverLifetime;
            color234.enabled = true;
            Gradient gradient234 = new Gradient();
            gradient234.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color234.color = gradient234;

            // Renderer
            ParticleSystemRenderer renderer234 = emitter234.GetComponent<ParticleSystemRenderer>();
            renderer234.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 235: Emitter_1004
            GameObject emitter235 = new GameObject("Emitter_235");
            emitter235.transform.SetParent(transform);
            emitter235.transform.localPosition = Vector3.zero;

            ParticleSystem ps235 = emitter235.AddComponent<ParticleSystem>();
            var main235 = ps235.main;
            main235.duration = 0.03f;
            main235.startLifetime = 0.03f;
            main235.startSpeed = 1.00f;
            main235.startSize = 0.100f;
            main235.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission235 = ps235.emission;
            emission235.rateOverTime = 160;

            // Shape
            var shape235 = ps235.shape;
            shape235.shapeType = ParticleSystemShapeType.Sphere;
            shape235.radius = 0.5f;

            // Color over lifetime
            var color235 = ps235.colorOverLifetime;
            color235.enabled = true;
            Gradient gradient235 = new Gradient();
            gradient235.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.88f, 0.88f), 1.00f)
            ...
            color235.color = gradient235;

            // Renderer
            ParticleSystemRenderer renderer235 = emitter235.GetComponent<ParticleSystemRenderer>();
            renderer235.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 236: Emitter_1004
            GameObject emitter236 = new GameObject("Emitter_236");
            emitter236.transform.SetParent(transform);
            emitter236.transform.localPosition = Vector3.zero;

            ParticleSystem ps236 = emitter236.AddComponent<ParticleSystem>();
            var main236 = ps236.main;
            main236.duration = 0.03f;
            main236.startLifetime = 0.03f;
            main236.startSpeed = 1.00f;
            main236.startSize = 0.100f;
            main236.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission236 = ps236.emission;
            emission236.rateOverTime = 3;

            // Shape
            var shape236 = ps236.shape;
            shape236.shapeType = ParticleSystemShapeType.Sphere;
            shape236.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer236 = emitter236.GetComponent<ParticleSystemRenderer>();
            renderer236.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 237: Emitter_1004
            GameObject emitter237 = new GameObject("Emitter_237");
            emitter237.transform.SetParent(transform);
            emitter237.transform.localPosition = Vector3.zero;

            ParticleSystem ps237 = emitter237.AddComponent<ParticleSystem>();
            var main237 = ps237.main;
            main237.duration = 0.03f;
            main237.startLifetime = 0.03f;
            main237.startSpeed = 1.00f;
            main237.startSize = 0.100f;
            main237.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission237 = ps237.emission;
            emission237.rateOverTime = 3;

            // Shape
            var shape237 = ps237.shape;
            shape237.shapeType = ParticleSystemShapeType.Sphere;
            shape237.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer237 = emitter237.GetComponent<ParticleSystemRenderer>();
            renderer237.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 238: Emitter_1004
            GameObject emitter238 = new GameObject("Emitter_238");
            emitter238.transform.SetParent(transform);
            emitter238.transform.localPosition = Vector3.zero;

            ParticleSystem ps238 = emitter238.AddComponent<ParticleSystem>();
            var main238 = ps238.main;
            main238.duration = 0.03f;
            main238.startLifetime = 0.03f;
            main238.startSpeed = 1.00f;
            main238.startSize = 0.100f;
            main238.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission238 = ps238.emission;
            emission238.rateOverTime = 3;

            // Shape
            var shape238 = ps238.shape;
            shape238.shapeType = ParticleSystemShapeType.Sphere;
            shape238.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer238 = emitter238.GetComponent<ParticleSystemRenderer>();
            renderer238.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 239: Emitter_1004
            GameObject emitter239 = new GameObject("Emitter_239");
            emitter239.transform.SetParent(transform);
            emitter239.transform.localPosition = Vector3.zero;

            ParticleSystem ps239 = emitter239.AddComponent<ParticleSystem>();
            var main239 = ps239.main;
            main239.duration = 0.03f;
            main239.startLifetime = 0.03f;
            main239.startSpeed = 1.00f;
            main239.startSize = 0.100f;
            main239.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission239 = ps239.emission;
            emission239.rateOverTime = 3;

            // Shape
            var shape239 = ps239.shape;
            shape239.shapeType = ParticleSystemShapeType.Sphere;
            shape239.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer239 = emitter239.GetComponent<ParticleSystemRenderer>();
            renderer239.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 240: Emitter_1004
            GameObject emitter240 = new GameObject("Emitter_240");
            emitter240.transform.SetParent(transform);
            emitter240.transform.localPosition = Vector3.zero;

            ParticleSystem ps240 = emitter240.AddComponent<ParticleSystem>();
            var main240 = ps240.main;
            main240.duration = 0.03f;
            main240.startLifetime = 0.03f;
            main240.startSpeed = 1.00f;
            main240.startSize = 0.100f;
            main240.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission240 = ps240.emission;
            emission240.rateOverTime = 3;

            // Shape
            var shape240 = ps240.shape;
            shape240.shapeType = ParticleSystemShapeType.Sphere;
            shape240.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer240 = emitter240.GetComponent<ParticleSystemRenderer>();
            renderer240.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 241: Emitter_1004
            GameObject emitter241 = new GameObject("Emitter_241");
            emitter241.transform.SetParent(transform);
            emitter241.transform.localPosition = Vector3.zero;

            ParticleSystem ps241 = emitter241.AddComponent<ParticleSystem>();
            var main241 = ps241.main;
            main241.duration = 0.03f;
            main241.startLifetime = 0.03f;
            main241.startSpeed = 1.00f;
            main241.startSize = 0.100f;
            main241.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission241 = ps241.emission;
            emission241.rateOverTime = 3;

            // Shape
            var shape241 = ps241.shape;
            shape241.shapeType = ParticleSystemShapeType.Sphere;
            shape241.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer241 = emitter241.GetComponent<ParticleSystemRenderer>();
            renderer241.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 242: Emitter_1004
            GameObject emitter242 = new GameObject("Emitter_242");
            emitter242.transform.SetParent(transform);
            emitter242.transform.localPosition = Vector3.zero;

            ParticleSystem ps242 = emitter242.AddComponent<ParticleSystem>();
            var main242 = ps242.main;
            main242.duration = 0.03f;
            main242.startLifetime = 0.03f;
            main242.startSpeed = 1.00f;
            main242.startSize = 0.100f;
            main242.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission242 = ps242.emission;
            emission242.rateOverTime = 3;

            // Shape
            var shape242 = ps242.shape;
            shape242.shapeType = ParticleSystemShapeType.Sphere;
            shape242.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer242 = emitter242.GetComponent<ParticleSystemRenderer>();
            renderer242.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 243: Emitter_1004
            GameObject emitter243 = new GameObject("Emitter_243");
            emitter243.transform.SetParent(transform);
            emitter243.transform.localPosition = Vector3.zero;

            ParticleSystem ps243 = emitter243.AddComponent<ParticleSystem>();
            var main243 = ps243.main;
            main243.duration = 0.03f;
            main243.startLifetime = 0.03f;
            main243.startSpeed = 1.00f;
            main243.startSize = 0.100f;
            main243.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission243 = ps243.emission;
            emission243.rateOverTime = 3;

            // Shape
            var shape243 = ps243.shape;
            shape243.shapeType = ParticleSystemShapeType.Sphere;
            shape243.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer243 = emitter243.GetComponent<ParticleSystemRenderer>();
            renderer243.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 244: Emitter_1004
            GameObject emitter244 = new GameObject("Emitter_244");
            emitter244.transform.SetParent(transform);
            emitter244.transform.localPosition = Vector3.zero;

            ParticleSystem ps244 = emitter244.AddComponent<ParticleSystem>();
            var main244 = ps244.main;
            main244.duration = 0.03f;
            main244.startLifetime = 0.03f;
            main244.startSpeed = 1.00f;
            main244.startSize = 0.100f;
            main244.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission244 = ps244.emission;
            emission244.rateOverTime = 3;

            // Shape
            var shape244 = ps244.shape;
            shape244.shapeType = ParticleSystemShapeType.Sphere;
            shape244.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer244 = emitter244.GetComponent<ParticleSystemRenderer>();
            renderer244.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 245: Emitter_1004
            GameObject emitter245 = new GameObject("Emitter_245");
            emitter245.transform.SetParent(transform);
            emitter245.transform.localPosition = Vector3.zero;

            ParticleSystem ps245 = emitter245.AddComponent<ParticleSystem>();
            var main245 = ps245.main;
            main245.duration = 3.00f;
            main245.startLifetime = 3.00f;
            main245.startSpeed = 1.00f;
            main245.startSize = 0.100f;
            main245.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission245 = ps245.emission;
            emission245.rateOverTime = 3;

            // Shape
            var shape245 = ps245.shape;
            shape245.shapeType = ParticleSystemShapeType.Sphere;
            shape245.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer245 = emitter245.GetComponent<ParticleSystemRenderer>();
            renderer245.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 246: Emitter_1004
            GameObject emitter246 = new GameObject("Emitter_246");
            emitter246.transform.SetParent(transform);
            emitter246.transform.localPosition = Vector3.zero;

            ParticleSystem ps246 = emitter246.AddComponent<ParticleSystem>();
            var main246 = ps246.main;
            main246.duration = 3.00f;
            main246.startLifetime = 3.00f;
            main246.startSpeed = 1.00f;
            main246.startSize = 0.100f;
            main246.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission246 = ps246.emission;
            emission246.rateOverTime = 3;

            // Shape
            var shape246 = ps246.shape;
            shape246.shapeType = ParticleSystemShapeType.Sphere;
            shape246.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer246 = emitter246.GetComponent<ParticleSystemRenderer>();
            renderer246.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 247: Emitter_1004
            GameObject emitter247 = new GameObject("Emitter_247");
            emitter247.transform.SetParent(transform);
            emitter247.transform.localPosition = Vector3.zero;

            ParticleSystem ps247 = emitter247.AddComponent<ParticleSystem>();
            var main247 = ps247.main;
            main247.duration = 3.00f;
            main247.startLifetime = 3.00f;
            main247.startSpeed = 1.00f;
            main247.startSize = 0.100f;
            main247.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission247 = ps247.emission;
            emission247.rateOverTime = 3;

            // Shape
            var shape247 = ps247.shape;
            shape247.shapeType = ParticleSystemShapeType.Sphere;
            shape247.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer247 = emitter247.GetComponent<ParticleSystemRenderer>();
            renderer247.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output

            // Emitter 248: Emitter_1004
            GameObject emitter248 = new GameObject("Emitter_248");
            emitter248.transform.SetParent(transform);
            emitter248.transform.localPosition = Vector3.zero;

            ParticleSystem ps248 = emitter248.AddComponent<ParticleSystem>();
            var main248 = ps248.main;
            main248.duration = 3.00f;
            main248.startLifetime = 3.00f;
            main248.startSpeed = 1.00f;
            main248.startSize = 0.100f;
            main248.simulationSpace = ParticleSystemSimulationSpace.World;

            // Emission
            var emission248 = ps248.emission;
            emission248.rateOverTime = 3;

            // Shape
            var shape248 = ps248.shape;
            shape248.shapeType = ParticleSystemShapeType.Sphere;
            shape248.radius = 0.5f;

            // Renderer
            ParticleSystemRenderer renderer248 = emitter248.GetComponent<ParticleSystemRenderer>();
            renderer248.renderMode = ParticleSystemRenderMode.Billboard;
            // Note: Assign particle material for visual output
