...
namespace IrithyllParticles
{
    ...
    /// Source: f000652401.fxr
    /// Effect ID: 652401
    /// Generated emitters: 96
    /// </summary>
    public class f000652401_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main22.duration = 3.00f;
            main22.startLifetime = 3.00f;
            ...
            main93.duration = 3.00f;
            main93.startLifetime = 3.00f;
            ...
            main94.duration = 3.00f;
            main94.startLifetime = 3.00f;
