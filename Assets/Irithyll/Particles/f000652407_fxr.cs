...
namespace IrithyllParticles
{
    ...
    /// Source: f000652407.fxr
    /// Effect ID: 652407
    /// Generated emitters: 36
    /// </summary>
    public class f000652407_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main7 = ps7.main;
            main7.duration = 9.33f;
            main7.startLifetime = 9.33f;
            ...
            main19.duration = 9.33f;
            main19.startLifetime = 9.33f;
            ...
            main36.duration = 9.33f;
            main36.startLifetime = 9.33f;
