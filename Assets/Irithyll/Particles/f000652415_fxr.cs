...
namespace IrithyllParticles
{
    ...
    /// Source: f000652415.fxr
    /// Effect ID: 652415
    /// Generated emitters: 36
    /// </summary>
    public class f000652415_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            gradient5.SetKeys(
                new GradientColorKey[] {
                    new GradientColorKey(new Color(1.00f, 0.85f, 0.75f), 0.00f),
                    new GradientColorKey(new Color(1.00f, 0.85f, 0.75f), 1.00f)
                },
