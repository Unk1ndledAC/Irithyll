...
namespace IrithyllParticles
{
    ...
    /// Source: f000837001.fxr
    /// Effect ID: 837001
    /// Generated emitters: 15
    /// </summary>
    public class f000837001_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
