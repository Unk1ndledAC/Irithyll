...
namespace IrithyllParticles
{
    ...
    /// Source: f000837020.fxr
    /// Effect ID: 837020
    /// Generated emitters: 21
    /// </summary>
    public class f000837020_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
