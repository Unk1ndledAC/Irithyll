...
namespace IrithyllParticles
{
    ...
    /// Source: f000837040.fxr
    /// Effect ID: 837040
    /// Generated emitters: 15
    /// </summary>
    public class f000837040_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
