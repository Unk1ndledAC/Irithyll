...
namespace IrithyllParticles
{
    ...
    /// Source: f000837061.fxr
    /// Effect ID: 837061
    /// Generated emitters: 94
    /// </summary>
    public class f000837061_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            main85.duration = 2.00f;
            main85.startLifetime = 2.00f;
            ...
            main88.duration = 2.00f;
            main88.startLifetime = 2.00f;
            ...
            main90.duration = 2.00f;
            main90.startLifetime = 2.00f;
