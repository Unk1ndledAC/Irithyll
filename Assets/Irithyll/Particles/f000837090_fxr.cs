...
namespace IrithyllParticles
{
    ...
    /// Source: f000837090.fxr
    /// Effect ID: 837090
    /// Generated emitters: 35
    /// </summary>
    public class f000837090_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main5 = ps5.main;
            main5.duration = 0.83f;
            main5.startLifetime = 0.83f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.67f;
            main8.startLifetime = 0.67f;
            ...
            main10.duration = 0.83f;
            main10.startLifetime = 0.83f;
            ...
            main16.duration = 0.83f;
            main16.startLifetime = 0.83f;
            ...
            main19.duration = 0.67f;
            main19.startLifetime = 0.67f;
            ...
            main23.duration = 0.67f;
            main23.startLifetime = 0.67f;
            ...
            main24.duration = 0.67f;
            main24.startLifetime = 0.67f;
            ...
            main27.duration = 0.83f;
            main27.startLifetime = 0.83f;
            ...
            main29.duration = 0.67f;
            main29.startLifetime = 0.67f;
            ...
            main30.duration = 0.67f;
            main30.startLifetime = 0.67f;
            ...
            main33.duration = 0.83f;
            main33.startLifetime = 0.83f;
            ...
            main34.duration = 0.83f;
            main34.startLifetime = 0.83f;
