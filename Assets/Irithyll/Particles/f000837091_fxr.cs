...
namespace IrithyllParticles
{
    ...
    /// Source: f000837091.fxr
    /// Effect ID: 837091
    /// Generated emitters: 15
    /// </summary>
    public class f000837091_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 2000.00f;
            main1.startLifetime = 2000.00f;
            ...
            var main4 = ps4.main;
            main4.duration = 2000.00f;
            main4.startLifetime = 2000.00f;
            ...
            var main9 = ps9.main;
            main9.duration = 2000.00f;
            main9.startLifetime = 2000.00f;
