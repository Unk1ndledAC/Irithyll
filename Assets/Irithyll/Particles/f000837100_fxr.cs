...
namespace IrithyllParticles
{
    ...
    /// Source: f000837100.fxr
    /// Effect ID: 837100
    /// Generated emitters: 9
    /// </summary>
    public class f000837100_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main1 = ps1.main;
            main1.duration = 1.50f;
            main1.startLifetime = 1.50f;
            ...
            var main7 = ps7.main;
            main7.duration = 0.67f;
            main7.startLifetime = 0.67f;
