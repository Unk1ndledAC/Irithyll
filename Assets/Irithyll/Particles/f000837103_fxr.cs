...
namespace IrithyllParticles
{
    ...
    /// Source: f000837103.fxr
    /// Effect ID: 837103
    /// Generated emitters: 19
    /// </summary>
    public class f000837103_fxr : MonoBehaviour
    {
        void Start()
        {
            SetupParticles();
        ...
        void SetupParticles()
        {
            ...
            var main3 = ps3.main;
            main3.duration = 0.83f;
            main3.startLifetime = 0.83f;
            ...
            var main6 = ps6.main;
            main6.duration = 0.83f;
            main6.startLifetime = 0.83f;
            ...
            var main8 = ps8.main;
            main8.duration = 0.83f;
            main8.startLifetime = 0.83f;
            ...
            var main9 = ps9.main;
            main9.duration = 0.83f;
            main9.startLifetime = 0.83f;
            ...
            main12.duration = 0.83f;
            main12.startLifetime = 0.83f;
            ...
            main17.duration = 0.83f;
            main17.startLifetime = 0.83f;
            ...
            main18.duration = 0.83f;
            main18.startLifetime = 0.83f;
